...
LIntExport Herror affine_trans_polygon_xld(const HObject& Polygons, HObject* PolygonsAffineTrans, const HTuple& HomMat2D);

LIntExport Herror affine_trans_contour_xld(const HObject& Contours, HObject* ContoursAffineTrans, const HTuple& HomMat2D);
...
LIntExport Herror create_scattered_data_interpolator(const HTuple& Method, const HTuple& Rows, const HTuple& Columns, const HTuple& Values, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ScatteredDataInterpolatorHandle);

LIntExport Herror interpolate_scattered_data_points_to_image(HObject* ImageInterpolated, const HTuple& Method, const HTuple& Rows, const HTuple& Columns, const HTuple& Values, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror interpolate_scattered_data_image(const HObject& Image, const HObject& RegionInterpolate, HObject* ImageInterpolated, const HTuple& Method, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror get_compute_device_param(const HTuple& DeviceHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror set_compute_device_param(const HTuple& DeviceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror get_socket_param(const HTuple& Socket, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror set_socket_param(const HTuple& Socket, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror query_sheet_of_light_params(const HTuple& SheetOfLightModelID, const HTuple& QueryName, HTuple* GenParamName);
...
LIntExport Herror create_sheet_of_light_model(const HObject& ProfileRegion, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* SheetOfLightModelID);
...
LIntExport Herror fit_primitives_object_model_3d(const HTuple& ObjectModel3D, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ObjectModel3DOut);

LIntExport Herror segment_object_model_3d(const HTuple& ObjectModel3D, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ObjectModel3DOut);
...
LIntExport Herror create_text_model_reader(const HTuple& Mode, const HTuple& OCRClassifier, HTuple* TextModel);
...
LIntExport Herror regiongrowing(const HObject& Image, HObject* Regions, const HTuple& RasterHeight, const HTuple& RasterWidth, const HTuple& Tolerance, const HTuple& MinSize);
...
LIntExport Herror get_stereo_model_param(const HTuple& StereoModelID, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror set_stereo_model_param(const HTuple& StereoModelID, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror optimize_aop(const HTuple& OperatorName, const HTuple& IconicType, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror write_aop_knowledge(const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror read_aop_knowledge(const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Attributes, HTuple* OperatorNames);
...
LIntExport Herror create_ocr_class_knn(const HTuple& WidthCharacter, const HTuple& HeightCharacter, const HTuple& Interpolation, const HTuple& Features, const HTuple& Characters, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle);

LIntExport Herror trainf_ocr_class_knn(const HTuple& OCRHandle, const HTuple& TrainingFile, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror select_feature_set_trainf_knn(const HTuple& TrainingFile, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);

LIntExport Herror select_feature_set_trainf_mlp_protected(const HTuple& TrainingFile, const HTuple& Password, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);

LIntExport Herror select_feature_set_trainf_mlp(const HTuple& TrainingFile, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);

LIntExport Herror select_feature_set_trainf_svm_protected(const HTuple& TrainingFile, const HTuple& Password, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);

LIntExport Herror select_feature_set_trainf_svm(const HTuple& TrainingFile, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);
...
LIntExport Herror get_sample_identifier_param(const HTuple& SampleIdentifier, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror set_sample_identifier_param(const HTuple& SampleIdentifier, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror train_sample_identifier(const HTuple& SampleIdentifier, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror create_sample_identifier(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* SampleIdentifier);
...
LIntExport Herror set_shape_model_param(const HTuple& ModelID, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror set_deformable_model_param(const HTuple& ModelID, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror get_deformable_model_params(const HTuple& ModelID, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport Herror set_ncc_model_param(const HTuple& ModelID, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror get_deformable_surface_model_param(const HTuple& DeformableSurfaceModel, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport Herror get_surface_model_param(const HTuple& SurfaceModelID, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport Herror get_shape_model_3d_params(const HTuple& ShapeModel3DID, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror find_shape_model_3d(const HObject& Image, const HTuple& ShapeModel3DID, const HTuple& MinScore, const HTuple& Greediness, const HTuple& NumLevels, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Pose, HTuple* CovPose, HTuple* Score);
...
LIntExport Herror distance_object_model_3d(const HTuple& ObjectModel3DFrom, const HTuple& ObjectModel3DTo, const HTuple& Pose, const HTuple& MaxDistance, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror get_object_model_3d_params(const HTuple& ObjectModel3D, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport Herror set_drawing_object_callback(const HTuple& DrawHandle, const HTuple& DrawObjectEvent, const HTuple& CallbackFunction);
...
LIntExport Herror detach_drawing_object_from_window(const HTuple& WindowHandle, const HTuple& DrawHandle);

LIntExport Herror attach_drawing_object_to_window(const HTuple& WindowHandle, const HTuple& DrawHandle);
...
LIntExport Herror set_drawing_object_params(const HTuple& DrawID, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror get_drawing_object_params(const HTuple& DrawID, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport Herror affine_trans_image_size(const HObject& Image, HObject* ImageAffineTrans, const HTuple& HomMat2D, const HTuple& Interpolation, const HTuple& Width, const HTuple& Height);

LIntExport Herror affine_trans_image(const HObject& Image, HObject* ImageAffineTrans, const HTuple& HomMat2D, const HTuple& Interpolation, const HTuple& AdaptImageSize);
...
LIntExport Herror read_polygon_xld_dxf(HObject* Polygons, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DxfStatus);

LIntExport Herror write_polygon_xld_dxf(const HObject& Polygons, const HTuple& FileName);

LIntExport Herror read_contour_xld_dxf(HObject* Contours, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DxfStatus);
...
LIntExport Herror find_data_code_2d(const HObject& Image, HObject* SymbolXLDs, const HTuple& DataCodeHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ResultHandles, HTuple* DecodedDataStrings);

LIntExport Herror set_data_code_2d_param(const HTuple& DataCodeHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror get_data_code_2d_param(const HTuple& DataCodeHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror query_data_code_2d_params(const HTuple& DataCodeHandle, const HTuple& QueryName, HTuple* GenParamName);
...
LIntExport Herror create_data_code_2d_model(const HTuple& SymbolType, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DataCodeHandle);
...
LIntExport Herror select_feature_set_mlp(const HTuple& ClassTrainDataHandle, const HTuple& SelectionMethod, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* MLPHandle, HTuple* SelectedFeatureIndices, HTuple* Score);

LIntExport Herror select_feature_set_svm(const HTuple& ClassTrainDataHandle, const HTuple& SelectionMethod, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* SVMHandle, HTuple* SelectedFeatureIndices, HTuple* Score);

LIntExport Herror select_feature_set_gmm(const HTuple& ClassTrainDataHandle, const HTuple& SelectionMethod, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* GMMHandle, HTuple* SelectedFeatureIndices, HTuple* Score);

LIntExport Herror select_feature_set_knn(const HTuple& ClassTrainDataHandle, const HTuple& SelectionMethod, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* KNNHandle, HTuple* SelectedFeatureIndices, HTuple* Score);
...
LIntExport Herror get_params_class_knn(const HTuple& KNNHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror set_params_class_knn(const HTuple& KNNHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror classify_class_knn(const HTuple& KNNHandle, const HTuple& Features, HTuple* Result, HTuple* Rating);

LIntExport Herror train_class_knn(const HTuple& KNNHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror create_class_lut_knn(const HTuple& KNNHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ClassLUTHandle);

LIntExport Herror create_class_lut_gmm(const HTuple& GMMHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ClassLUTHandle);

LIntExport Herror create_class_lut_svm(const HTuple& SVMHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ClassLUTHandle);

LIntExport Herror create_class_lut_mlp(const HTuple& MLPHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ClassLUTHandle);
...
LIntExport Herror get_camera_setup_param(const HTuple& CameraSetupModelID, const HTuple& CameraIdx, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror set_camera_setup_param(const HTuple& CameraSetupModelID, const HTuple& CameraIdx, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror get_bead_inspection_param(const HTuple& BeadInspectionModel, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror set_bead_inspection_param(const HTuple& BeadInspectionModel, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport Herror create_bead_inspection_model(const HObject& BeadContour, const HTuple& TargetThickness, const HTuple& ThicknessTolerance, const HTuple& PositionTolerance, const HTuple& Polarity, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* BeadInspectionModel);
...
LIntExport Herror query_bar_code_params(const HTuple& BarCodeHandle, const HTuple& Properties, HTuple* GenParamName);

LIntExport Herror get_bar_code_param_specific(const HTuple& BarCodeHandle, const HTuple& CodeTypes, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_bar_code_param(const HTuple& BarCodeHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror set_bar_code_param_specific(const HTuple& BarCodeHandle, const HTuple& CodeTypes, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror set_bar_code_param(const HTuple& BarCodeHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror clear_all_bar_code_models();

LIntExport Herror clear_bar_code_model(const HTuple& BarCodeHandle);

LIntExport Herror create_bar_code_model(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* BarCodeHandle);
...
LIntExport Herror control_io_channel(const HTuple& IOChannelHandle, const HTuple& ParamAction, const HTuple& ParamArgument, HTuple* GenParamValue);
...
LIntExport Herror set_io_channel_param(const HTuple& IOChannelHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror get_io_channel_param(const HTuple& IOChannelHandle, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport Herror set_io_device_param(const HTuple& IODeviceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror get_io_device_param(const HTuple& IODeviceHandle, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport Herror add_scene_3d_label(const HTuple& Scene3D, const HTuple& Text, const HTuple& ReferencePoint, const HTuple& Position, const HTuple& RelatesTo, HTuple* LabelIndex);

LIntExport Herror remove_scene_3d_label(const HTuple& Scene3D, const HTuple& LabelIndex);

LIntExport Herror set_scene_3d_label_param(const HTuple& Scene3D, const HTuple& LabelIndex, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror add_texture_inspection_model_image(const HObject& Image, const HTuple& TextureInspectionModel, HTuple* Indices);

LIntExport Herror apply_texture_inspection_model(const HObject& Image, HObject* NoveltyRegion, const HTuple& TextureInspectionModel, HTuple* TextureInspectionResultID);

LIntExport Herror bilateral_filter(const HObject& Image, const HObject& ImageJoint, HObject* ImageBilateral, const HTuple& SigmaSpatial, const HTuple& SigmaRange, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror clear_ocr_class_cnn(const HTuple& OCRHandle);

LIntExport Herror clear_texture_inspection_model(const HTuple& TextureInspectionModel);

LIntExport Herror clear_texture_inspection_result(const HTuple& TextureInspectionResultID);

LIntExport Herror convert_coordinates_image_to_window(const HTuple& WindowHandle, const HTuple& RowImage, const HTuple& ColumnImage, HTuple* RowWindow, HTuple* ColumnWindow);

LIntExport Herror convert_coordinates_window_to_image(const HTuple& WindowHandle, const HTuple& RowWindow, const HTuple& ColumnWindow, HTuple* RowImage, HTuple* ColumnImage);

LIntExport Herror create_texture_inspection_model(const HTuple& ModelType, HTuple* TextureInspectionModel);

LIntExport Herror deserialize_dual_quat(const HTuple& SerializedItemHandle, HTuple* DualQuaternion);

LIntExport Herror deserialize_ocr_class_cnn(const HTuple& SerializedItemHandle, HTuple* OCRHandle);

LIntExport Herror deserialize_texture_inspection_model(const HTuple& SerializedItemHandle, HTuple* TextureInspectionModel);

LIntExport Herror disp_text(const HTuple& WindowHandle, const HTuple& String, const HTuple& CoordSystem, const HTuple& Row, const HTuple& Column, const HTuple& Color, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror do_ocr_multi_class_cnn(const HObject& Character, const HObject& Image, const HTuple& OCRHandle, HTuple* Class, HTuple* Confidence);

LIntExport Herror do_ocr_single_class_cnn(const HObject& Character, const HObject& Image, const HTuple& OCRHandle, const HTuple& Num, HTuple* Class, HTuple* Confidence);

LIntExport Herror do_ocr_word_cnn(const HObject& Character, const HObject& Image, const HTuple& OCRHandle, const HTuple& Expression, const HTuple& NumAlternatives, const HTuple& NumCorrections, HTuple* Class, HTuple* Confidence, HTuple* Word, HTuple* Score);

LIntExport Herror dual_quat_compose(const HTuple& DualQuaternionLeft, const HTuple& DualQuaternionRight, HTuple* DualQuaternionComposed);

LIntExport Herror dual_quat_conjugate(const HTuple& DualQuaternion, HTuple* DualQuaternionConjugate);

LIntExport Herror dual_quat_interpolate(const HTuple& DualQuaternionStart, const HTuple& DualQuaternionEnd, const HTuple& InterpPos, HTuple* DualQuaternionInterpolated);

LIntExport Herror dual_quat_normalize(const HTuple& DualQuaternion, HTuple* DualQuaternionNormalized);

LIntExport Herror dual_quat_to_hom_mat3d(const HTuple& DualQuaternion, HTuple* HomMat3D);

LIntExport Herror dual_quat_to_pose(const HTuple& DualQuaternion, HTuple* Pose);

LIntExport Herror dual_quat_to_screw(const HTuple& DualQuaternion, const HTuple& ScrewFormat, HTuple* AxisDirectionX, HTuple* AxisDirectionY, HTuple* AxisDirectionZ, HTuple* AxisMomentOrPointX, HTuple* AxisMomentOrPointY, HTuple* AxisMomentOrPointZ, HTuple* Rotation, HTuple* Translation);

LIntExport Herror dual_quat_trans_line_3d(const HTuple& DualQuaternion, const HTuple& LineFormat, const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentOrPointX, const HTuple& LineMomentOrPointY, const HTuple& LineMomentOrPointZ, HTuple* TransLineDirectionX, HTuple* TransLineDirectionY, HTuple* TransLineDirectionZ, HTuple* TransLineMomentOrPointX, HTuple* TransLineMomentOrPointY, HTuple* TransLineMomentOrPointZ);

LIntExport Herror edges_object_model_3d(const HTuple& ObjectModel3D, const HTuple& MinAmplitude, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ObjectModel3DEdges);

LIntExport Herror find_ncc_models(const HObject& Image, const HTuple& ModelIDs, const HTuple& AngleStart, const HTuple& AngleExtent, const HTuple& MinScore, const HTuple& NumMatches, const HTuple& MaxOverlap, const HTuple& SubPixel, const HTuple& NumLevels, HTuple* Row, HTuple* Column, HTuple* Angle, HTuple* Score, HTuple* Model);

LIntExport Herror find_surface_model_image(const HObject& Image, const HTuple& SurfaceModelID, const HTuple& ObjectModel3D, const HTuple& RelSamplingDistance, const HTuple& KeyPointFraction, const HTuple& MinScore, const HTuple& ReturnResultHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Pose, HTuple* Score, HTuple* SurfaceMatchingResultID);

LIntExport Herror flush_buffer(const HTuple& WindowHandle);

LIntExport Herror get_ncc_model_region(HObject* ModelRegion, const HTuple& ModelID);

LIntExport Herror get_params_ocr_class_cnn(const HTuple& OCRHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_rgba(const HTuple& WindowHandle, HTuple* Red, HTuple* Green, HTuple* Blue, HTuple* Alpha);

LIntExport Herror get_stereo_model_object_model_3d(const HTuple& StereoModelID, const HTuple& GenParamName, HTuple* ObjectModel3D);

LIntExport Herror get_texture_inspection_model_image(HObject* ImageOut, const HTuple& TextureInspectionModel);

LIntExport Herror get_texture_inspection_model_param(const HTuple& TextureInspectionModel, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_texture_inspection_result_object(HObject* Object, const HTuple& TextureInspectionResultID, const HTuple& ResultName);

LIntExport Herror guided_filter(const HObject& Image, const HObject& ImageGuide, HObject* ImageGuided, const HTuple& Radius, const HTuple& Amplitude);

LIntExport Herror interleave_channels(const HObject& MultichannelImage, HObject* InterleavedImage, const HTuple& PixelFormat, const HTuple& RowBytes, const HTuple& Alpha);

LIntExport Herror pose_to_dual_quat(const HTuple& Pose, HTuple* DualQuaternion);

LIntExport Herror query_params_ocr_class_cnn(const HTuple& OCRHandle, HTuple* GenParamName);

LIntExport Herror read_ocr_class_cnn(const HTuple& FileName, HTuple* OCRHandle);

LIntExport Herror read_texture_inspection_model(const HTuple& FileName, HTuple* TextureInspectionModel);

LIntExport Herror refine_surface_model_pose_image(const HObject& Image, const HTuple& SurfaceModelID, const HTuple& ObjectModel3D, const HTuple& InitialPose, const HTuple& MinScore, const HTuple& ReturnResultHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Pose, HTuple* Score, HTuple* SurfaceMatchingResultID);

LIntExport Herror remove_texture_inspection_model_image(const HTuple& TextureInspectionModel, const HTuple& Indices, HTuple* RemainingIndices);

LIntExport Herror screw_to_dual_quat(const HTuple& ScrewFormat, const HTuple& AxisDirectionX, const HTuple& AxisDirectionY, const HTuple& AxisDirectionZ, const HTuple& AxisMomentOrPointX, const HTuple& AxisMomentOrPointY, const HTuple& AxisMomentOrPointZ, const HTuple& Rotation, const HTuple& Translation, HTuple* DualQuaternion);

LIntExport Herror segment_image_mser(const HObject& Image, HObject* MSERDark, HObject* MSERLight, const HTuple& Polarity, const HTuple& MinArea, const HTuple& MaxArea, const HTuple& Delta, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror send_mouse_double_click_event(const HTuple& WindowHandle, const HTuple& Row, const HTuple& Column, const HTuple& Button, HTuple* Processed);

LIntExport Herror send_mouse_down_event(const HTuple& WindowHandle, const HTuple& Row, const HTuple& Column, const HTuple& Button, HTuple* Processed);

LIntExport Herror send_mouse_drag_event(const HTuple& WindowHandle, const HTuple& Row, const HTuple& Column, const HTuple& Button, HTuple* Processed);

LIntExport Herror send_mouse_up_event(const HTuple& WindowHandle, const HTuple& Row, const HTuple& Column, const HTuple& Button, HTuple* Processed);

LIntExport Herror serialize_dual_quat(const HTuple& DualQuaternion, HTuple* SerializedItemHandle);

LIntExport Herror serialize_ocr_class_cnn(const HTuple& OCRHandle, HTuple* SerializedItemHandle);

LIntExport Herror serialize_texture_inspection_model(const HTuple& TextureInspectionModel, HTuple* SerializedItemHandle);

LIntExport Herror set_content_update_callback(const HTuple& WindowHandle, const HTuple& CallbackFunction, const HTuple& CallbackContext);

LIntExport Herror set_rgba(const HTuple& WindowHandle, const HTuple& Red, const HTuple& Green, const HTuple& Blue, const HTuple& Alpha);

LIntExport Herror set_surface_model_param(const HTuple& SurfaceModelID, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror set_texture_inspection_model_param(const HTuple& TextureInspectionModel, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror train_texture_inspection_model(const HTuple& TextureInspectionModel);

LIntExport Herror write_texture_inspection_model(const HTuple& TextureInspectionModel, const HTuple& FileName);

LIntExport Herror uncalibrated_photometric_stereo(const HObject& Images, HObject* NormalField, HObject* Gradient, HObject* Albedo, const HTuple& ResultType);

LIntExport Herror apply_dl_classifier(const HObject& Images, const HTuple& DLClassifierHandle, HTuple* DLClassifierResultHandle);

LIntExport Herror clear_dl_classifier(const HTuple& DLClassifierHandle);

LIntExport Herror clear_dl_classifier_result(const HTuple& DLClassifierResultHandle);

LIntExport Herror clear_dl_classifier_train_result(const HTuple& DLClassifierTrainResultHandle);

LIntExport Herror clear_structured_light_model(const HTuple& StructuredLightModel);

LIntExport Herror create_structured_light_model(const HTuple& ModelType, HTuple* StructuredLightModel);

LIntExport Herror decode_structured_light_pattern(const HObject& CameraImages, const HTuple& StructuredLightModel);

LIntExport Herror deserialize_dl_classifier(const HTuple& SerializedItemHandle, HTuple* DLClassifierHandle);

LIntExport Herror deserialize_structured_light_model(const HTuple& SerializedItemHandle, HTuple* StructuredLightModel);

LIntExport Herror distance_cc_min_points(const HObject& Contour1, const HObject& Contour2, const HTuple& Mode, HTuple* DistanceMin, HTuple* Row1, HTuple* Column1, HTuple* Row2, HTuple* Column2);

LIntExport Herror fuse_object_model_3d(const HTuple& ObjectModel3D, const HTuple& BoundingBox, const HTuple& Resolution, const HTuple& SurfaceTolerance, const HTuple& MinThickness, const HTuple& Smoothing, const HTuple& NormalDirection, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ObjectModel3DFusion);

LIntExport Herror gen_structured_light_pattern(HObject* PatternImages, const HTuple& StructuredLightModel);

LIntExport Herror get_dl_classifier_param(const HTuple& DLClassifierHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_dl_classifier_result(const HTuple& DLClassifierResultHandle, const HTuple& Index, const HTuple& GenResultName, HTuple* GenResultValue);

LIntExport Herror get_dl_classifier_train_result(const HTuple& DLClassifierTrainResultHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_structured_light_model_param(const HTuple& StructuredLightModel, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_structured_light_object(HObject* Object, const HTuple& StructuredLightModel, const HTuple& ObjectName);

LIntExport Herror height_width_ratio(const HObject& Regions, HTuple* Height, HTuple* Width, HTuple* Ratio);

LIntExport Herror height_width_ratio_xld(const HObject& XLD, HTuple* Height, HTuple* Width, HTuple* Ratio);

LIntExport Herror insert_obj(const HObject& Objects, const HObject& ObjectsInsert, HObject* ObjectsExtended, const HTuple& Index);

LIntExport Herror read_dl_classifier(const HTuple& FileName, HTuple* DLClassifierHandle);

LIntExport Herror read_structured_light_model(const HTuple& FileName, HTuple* StructuredLightModel);

LIntExport Herror remove_obj(const HObject& Objects, HObject* ObjectsReduced, const HTuple& Index);

LIntExport Herror replace_obj(const HObject& Objects, const HObject& ObjectsReplace, HObject* Replaced, const HTuple& Index);

LIntExport Herror serialize_dl_classifier(const HTuple& DLClassifierHandle, HTuple* SerializedItemHandle);

LIntExport Herror serialize_structured_light_model(const HTuple& StructuredLightModel, HTuple* SerializedItemHandle);

LIntExport Herror set_dl_classifier_param(const HTuple& DLClassifierHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror set_operator_timeout(const HTuple& OperatorName, const HTuple& Timeout, const HTuple& Mode);

LIntExport Herror set_structured_light_model_param(const HTuple& StructuredLightModel, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror train_dl_classifier_batch(const HObject& BatchImages, const HTuple& DLClassifierHandle, const HTuple& BatchLabels, HTuple* DLClassifierTrainResultHandle);

LIntExport Herror write_dl_classifier(const HTuple& DLClassifierHandle, const HTuple& FileName);

LIntExport Herror write_structured_light_model(const HTuple& StructuredLightModel, const HTuple& FileName);

LIntExport Herror clear_handle(const HTuple& Handle);

LIntExport Herror deserialize_handle(const HTuple& SerializedItem, HTuple* Handle);

LIntExport Herror handle_to_integer(const HTuple& Handle, HTuple* CastedHandle);

LIntExport Herror integer_to_handle(const HTuple& IntegerHandle, HTuple* Handle);

LIntExport Herror serialize_handle(const HTuple& Handle, HTuple* SerializedItem);

LIntExport Herror tuple_is_handle(const HTuple& T, HTuple* IsHandle);

LIntExport Herror tuple_is_handle_elem(const HTuple& T, HTuple* IsHandle);

LIntExport Herror tuple_is_serializable(const HTuple& Tuple, HTuple* IsSerializable);

LIntExport Herror tuple_is_serializable_elem(const HTuple& Tuple, HTuple* IsSerializableElem);

LIntExport Herror tuple_is_valid_handle(const HTuple& Handle, HTuple* IsValid);

LIntExport Herror tuple_sem_type(const HTuple& T, HTuple* SemType);

LIntExport Herror tuple_sem_type_elem(const HTuple& T, HTuple* SemTypes);

LIntExport Herror apply_dl_model(const HTuple& DLModelHandle, const HTuple& DLSampleBatch, const HTuple& Outputs, HTuple* DLResultBatch);

LIntExport Herror clear_dl_model(const HTuple& DLModelHandle);

LIntExport Herror copy_dict(const HTuple& DictHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* CopiedDictHandle);

LIntExport Herror create_dict(HTuple* DictHandle);

LIntExport Herror create_dl_model_detection(const HTuple& Backbone, const HTuple& NumClasses, const HTuple& DLModelDetectionParam, HTuple* DLModelHandle);

LIntExport Herror deserialize_dl_model(const HTuple& SerializedItemHandle, HTuple* DLModelHandle);

LIntExport Herror get_current_hthread_id(HTuple* HThreadID);

LIntExport Herror get_dict_object(HObject* Object, const HTuple& DictHandle, const HTuple& Key);

LIntExport Herror get_dict_param(const HTuple& DictHandle, const HTuple& GenParamName, const HTuple& Key, HTuple* GenParamValue);

LIntExport Herror get_dict_tuple(const HTuple& DictHandle, const HTuple& Key, HTuple* Tuple);

LIntExport Herror get_dl_model_param(const HTuple& DLModelHandle, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror get_handle_object(HObject* Object, const HTuple& Handle, const HTuple& Key);

LIntExport Herror get_handle_param(const HTuple& Handle, const HTuple& GenParamName, const HTuple& Key, HTuple* GenParamValue);

LIntExport Herror get_handle_tuple(const HTuple& Handle, const HTuple& Key, HTuple* Tuple);

LIntExport Herror get_system_info(const HTuple& Query, HTuple* Information);

LIntExport Herror interrupt_operator(const HTuple& HThreadID, const HTuple& Mode);

LIntExport Herror read_dict(const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DictHandle);

LIntExport Herror read_dl_model(const HTuple& FileName, HTuple* DLModelHandle);

LIntExport Herror read_message(const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* MessageHandle);

LIntExport Herror remove_dict_key(const HTuple& DictHandle, const HTuple& Key);

LIntExport Herror send_key_press_event(const HTuple& WindowHandle, const HTuple& Char, const HTuple& Code);

LIntExport Herror send_key_release_event(const HTuple& WindowHandle, const HTuple& Char, const HTuple& Code);

LIntExport Herror serialize_dl_model(const HTuple& DLModelHandle, HTuple* SerializedItemHandle);

LIntExport Herror set_dict_object(const HObject& Object, const HTuple& DictHandle, const HTuple& Key);

LIntExport Herror set_dict_tuple(const HTuple& DictHandle, const HTuple& Key, const HTuple& Tuple);

LIntExport Herror set_dl_model_param(const HTuple& DLModelHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror train_dl_model_batch(const HTuple& DLModelHandle, const HTuple& DLSampleBatch, HTuple* DLTrainResult);

LIntExport Herror write_dict(const HTuple& DictHandle, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror write_dl_model(const HTuple& DLModelHandle, const HTuple& FileName);

LIntExport Herror write_message(const HTuple& MessageHandle, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror area_intersection_rectangle2(const HTuple& Rect1Row, const HTuple& Rect1Column, const HTuple& Rect1Phi, const HTuple& Rect1Length1, const HTuple& Rect1Length2, const HTuple& Rect2Row, const HTuple& Rect2Column, const HTuple& Rect2Phi, const HTuple& Rect2Length1, const HTuple& Rect2Length2, HTuple* AreaIntersection);

LIntExport Herror get_contour_style(const HTuple& WindowHandle, HTuple* Style);

LIntExport Herror get_shape_model_clutter(HObject* ClutterRegion, const HTuple& ModelID, const HTuple& GenParamName, HTuple* GenParamValue, HTuple* HomMat2D, HTuple* ClutterContrast);

LIntExport Herror set_contour_style(const HTuple& WindowHandle, const HTuple& Style);

LIntExport Herror set_shape_model_clutter(const HObject& ClutterRegion, const HTuple& ModelID, const HTuple& HomMat2D, const HTuple& ClutterContrast, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror find_box_3d(const HTuple& ObjectModel3DScene, const HTuple& SideLen1, const HTuple& SideLen2, const HTuple& SideLen3, const HTuple& MinScore, const HTuple& GenParam, HTuple* GrippingPose, HTuple* Score, HTuple* ObjectModel3DBox, HTuple* BoxInformation);

LIntExport Herror fread_bytes(const HTuple& FileHandle, const HTuple& NumberOfBytes, HTuple* ReadData, HTuple* IsEOF);

LIntExport Herror fwrite_bytes(const HTuple& FileHandle, const HTuple& DataToWrite, HTuple* NumberOfBytesWritten);

LIntExport Herror gen_dl_model_heatmap(const HTuple& DLModelHandle, const HTuple& DLSample, const HTuple& HeatmapMethod, const HTuple& TargetClasses, const HTuple& GenParam, HTuple* DLResult);

LIntExport Herror read_image_metadata(const HTuple& Format, const HTuple& TagName, const HTuple& FileName, HTuple* TagValue);

LIntExport Herror rectangularity_xld(const HObject& XLD, HTuple* Rectangularity);

LIntExport Herror remove_object_model_3d_attrib(const HTuple& ObjectModel3D, const HTuple& Attributes, HTuple* ObjectModel3DOut);

LIntExport Herror remove_object_model_3d_attrib_mod(const HTuple& ObjectModel3D, const HTuple& Attributes);

LIntExport Herror train_dl_model_anomaly_dataset(const HTuple& DLModelHandle, const HTuple& DLSamples, const HTuple& DLTrainParam, HTuple* DLTrainResult);

LIntExport Herror watersheds_marker(const HObject& Image, const HObject& Markers, HObject* Basins);

LIntExport Herror write_image_metadata(const HTuple& Format, const HTuple& TagName, const HTuple& TagValue, const HTuple& FileName);
