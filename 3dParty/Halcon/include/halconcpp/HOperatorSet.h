...
LIntExport void AffineTransPolygonXld(const HObject& Polygons, HObject* PolygonsAffineTrans, const HTuple& HomMat2D);

// Apply an arbitrary affine 2D transformation to XLD contours.
LIntExport void AffineTransContourXld(const HObject& Contours, HObject* ContoursAffineTrans, const HTuple& HomMat2D);
...
LIntExport void CreateScatteredDataInterpolator(const HTuple& Method, const HTuple& Rows, const HTuple& Columns, const HTuple& Values, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ScatteredDataInterpolatorHandle);

// Creating an image from the interpolation of scattered data.
LIntExport void InterpolateScatteredDataPointsToImage(HObject* ImageInterpolated, const HTuple& Method, const HTuple& Rows, const HTuple& Columns, const HTuple& Values, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue);

// Interpolation of an image.
LIntExport void InterpolateScatteredDataImage(const HObject& Image, const HObject& RegionInterpolate, HObject* ImageInterpolated, const HTuple& Method, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void GetComputeDeviceParam(const HTuple& DeviceHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Set parameters of an compute device.
LIntExport void SetComputeDeviceParam(const HTuple& DeviceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void GetSocketParam(const HTuple& Socket, const HTuple& GenParamName, HTuple* GenParamValue);

// Set a socket parameter.
LIntExport void SetSocketParam(const HTuple& Socket, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void QuerySheetOfLightParams(const HTuple& SheetOfLightModelID, const HTuple& QueryName, HTuple* GenParamName);
...
LIntExport void CreateSheetOfLightModel(const HObject& ProfileRegion, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* SheetOfLightModelID);
...
LIntExport void FitPrimitivesObjectModel3d(const HTuple& ObjectModel3D, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ObjectModel3DOut);

// Segment a set of 3D points into sub-sets with similar characteristics.
LIntExport void SegmentObjectModel3d(const HTuple& ObjectModel3D, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ObjectModel3DOut);
...
// Create a text model.
LIntExport void CreateTextModelReader(const HTuple& Mode, const HTuple& OCRClassifier, HTuple* TextModel);
...
LIntExport void Regiongrowing(const HObject& Image, HObject* Regions, const HTuple& RasterHeight, const HTuple& RasterWidth, const HTuple& Tolerance, const HTuple& MinSize);
...
LIntExport void GetStereoModelParam(const HTuple& StereoModelID, const HTuple& GenParamName, HTuple* GenParamValue);

// Set stereo model parameters.
LIntExport void SetStereoModelParam(const HTuple& StereoModelID, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void OptimizeAop(const HTuple& OperatorName, const HTuple& IconicType, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue);

// Write knowledge about hardware dependent behavior of automatic operator parallelization to file.
LIntExport void WriteAopKnowledge(const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue);

// Load knowledge about hardware dependent behavior of automatic operator parallelization.
LIntExport void ReadAopKnowledge(const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Attributes, HTuple* OperatorNames);
...
LIntExport void CreateOcrClassKnn(const HTuple& WidthCharacter, const HTuple& HeightCharacter, const HTuple& Interpolation, const HTuple& Features, const HTuple& Characters, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle);

// Trains an k-NN classifier for an OCR task.
LIntExport void TrainfOcrClassKnn(const HTuple& OCRHandle, const HTuple& TrainingFile, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void SelectFeatureSetTrainfKnn(const HTuple& TrainingFile, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);

// Select an optimal combination of features to classify OCR data from a (protected) training file.
LIntExport void SelectFeatureSetTrainfMlpProtected(const HTuple& TrainingFile, const HTuple& Password, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);

// Selects an optimal combination of features to classify OCR data.
LIntExport void SelectFeatureSetTrainfMlp(const HTuple& TrainingFile, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);

// Select an optimal combination of features to classify OCR data from a (protected) training file.
LIntExport void SelectFeatureSetTrainfSvmProtected(const HTuple& TrainingFile, const HTuple& Password, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);

// Selects an optimal combination of features to classify OCR  data.
LIntExport void SelectFeatureSetTrainfSvm(const HTuple& TrainingFile, const HTuple& FeatureList, const HTuple& SelectionMethod, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* OCRHandle, HTuple* FeatureSet, HTuple* Score);
...
LIntExport void GetSampleIdentifierParam(const HTuple& SampleIdentifier, const HTuple& GenParamName, HTuple* GenParamValue);

// Set selected parameters of a sample identifier.
LIntExport void SetSampleIdentifierParam(const HTuple& SampleIdentifier, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void TrainSampleIdentifier(const HTuple& SampleIdentifier, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void CreateSampleIdentifier(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* SampleIdentifier);
...
LIntExport void SetShapeModelParam(const HTuple& ModelID, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void SetDeformableModelParam(const HTuple& ModelID, const HTuple& GenParamName, const HTuple& GenParamValue);

// Return the parameters of a deformable model.
LIntExport void GetDeformableModelParams(const HTuple& ModelID, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport void SetNccModelParam(const HTuple& ModelID, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void GetDeformableSurfaceModelParam(const HTuple& DeformableSurfaceModel, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport void GetSurfaceModelParam(const HTuple& SurfaceModelID, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport void GetShapeModel3dParams(const HTuple& ShapeModel3DID, const HTuple& GenParamName, HTuple* GenParamValue);

// Find the best matches of a 3D shape model in an image.
LIntExport void FindShapeModel3d(const HObject& Image, const HTuple& ShapeModel3DID, const HTuple& MinScore, const HTuple& Greediness, const HTuple& NumLevels, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Pose, HTuple* CovPose, HTuple* Score);
...
LIntExport void DistanceObjectModel3d(const HTuple& ObjectModel3DFrom, const HTuple& ObjectModel3DTo, const HTuple& Pose, const HTuple& MaxDistance, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void GetObjectModel3dParams(const HTuple& ObjectModel3D, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport void SetDrawingObjectCallback(const HTuple& DrawHandle, const HTuple& DrawObjectEvent, const HTuple& CallbackFunction);
...
LIntExport void DetachDrawingObjectFromWindow(const HTuple& WindowHandle, const HTuple& DrawHandle);

// Attach an existing drawing object to a HALCON window.
LIntExport void AttachDrawingObjectToWindow(const HTuple& WindowHandle, const HTuple& DrawHandle);
...
LIntExport void SetDrawingObjectParams(const HTuple& DrawID, const HTuple& GenParamName, const HTuple& GenParamValue);

// Get the parameters of a drawing object.
LIntExport void GetDrawingObjectParams(const HTuple& DrawID, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport void AffineTransImageSize(const HObject& Image, HObject* ImageAffineTrans, const HTuple& HomMat2D, const HTuple& Interpolation, const HTuple& Width, const HTuple& Height);

// Apply an arbitrary affine 2D transformation to images.
LIntExport void AffineTransImage(const HObject& Image, HObject* ImageAffineTrans, const HTuple& HomMat2D, const HTuple& Interpolation, const HTuple& AdaptImageSize);
...
LIntExport void ReadPolygonXldDxf(HObject* Polygons, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DxfStatus);
...
LIntExport void ReadContourXldDxf(HObject* Contours, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DxfStatus);
...
LIntExport void FindDataCode2d(const HObject& Image, HObject* SymbolXLDs, const HTuple& DataCodeHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ResultHandles, HTuple* DecodedDataStrings);

// Set selected parameters of the 2D data code model.
LIntExport void SetDataCode2dParam(const HTuple& DataCodeHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Get one or several parameters that describe the 2D data code model.
LIntExport void GetDataCode2dParam(const HTuple& DataCodeHandle, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport void QueryDataCode2dParams(const HTuple& DataCodeHandle, const HTuple& QueryName, HTuple* GenParamName);
...
LIntExport void CreateDataCode2dModel(const HTuple& SymbolType, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DataCodeHandle);
...
LIntExport void SelectFeatureSetMlp(const HTuple& ClassTrainDataHandle, const HTuple& SelectionMethod, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* MLPHandle, HTuple* SelectedFeatureIndices, HTuple* Score);

// Selects an optimal combination of features to classify the provided data.
LIntExport void SelectFeatureSetSvm(const HTuple& ClassTrainDataHandle, const HTuple& SelectionMethod, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* SVMHandle, HTuple* SelectedFeatureIndices, HTuple* Score);

// Selects an optimal combination from a set of features to classify the  provided data.
LIntExport void SelectFeatureSetGmm(const HTuple& ClassTrainDataHandle, const HTuple& SelectionMethod, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* GMMHandle, HTuple* SelectedFeatureIndices, HTuple* Score);

// Selects an optimal subset from a set of features to solve a certain  classification problem.
LIntExport void SelectFeatureSetKnn(const HTuple& ClassTrainDataHandle, const HTuple& SelectionMethod, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* KNNHandle, HTuple* SelectedFeatureIndices, HTuple* Score);
...
LIntExport void GetParamsClassKnn(const HTuple& KNNHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Set parameters for k-NN classification.
LIntExport void SetParamsClassKnn(const HTuple& KNNHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void TrainClassKnn(const HTuple& KNNHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void CreateClassLutKnn(const HTuple& KNNHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ClassLUTHandle);

// Create a look-up table using a gaussian mixture model to classify byte images.
LIntExport void CreateClassLutGmm(const HTuple& GMMHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ClassLUTHandle);

// Create a look-up table using a Support-Vector-Machine to classify byte images.
LIntExport void CreateClassLutSvm(const HTuple& SVMHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ClassLUTHandle);

// Create a look-up table using a multi-layer perceptron to classify byte images.
LIntExport void CreateClassLutMlp(const HTuple& MLPHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ClassLUTHandle);
...
LIntExport void GetCameraSetupParam(const HTuple& CameraSetupModelID, const HTuple& CameraIdx, const HTuple& GenParamName, HTuple* GenParamValue);

// Set generic camera setup model parameters.
LIntExport void SetCameraSetupParam(const HTuple& CameraSetupModelID, const HTuple& CameraIdx, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void GetBeadInspectionParam(const HTuple& BeadInspectionModel, const HTuple& GenParamName, HTuple* GenParamValue);

// Set parameters of the bead inspection model.
LIntExport void SetBeadInspectionParam(const HTuple& BeadInspectionModel, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void CreateBeadInspectionModel(const HObject& BeadContour, const HTuple& TargetThickness, const HTuple& ThicknessTolerance, const HTuple& PositionTolerance, const HTuple& Polarity, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* BeadInspectionModel);
...
LIntExport void QueryBarCodeParams(const HTuple& BarCodeHandle, const HTuple& Properties, HTuple* GenParamName);

// Get parameters that are used by the bar code reader when processing a specific bar code type. 
LIntExport void GetBarCodeParamSpecific(const HTuple& BarCodeHandle, const HTuple& CodeTypes, const HTuple& GenParamName, HTuple* GenParamValue);

// Get one or several parameters that describe the bar code model.
LIntExport void GetBarCodeParam(const HTuple& BarCodeHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Set selected parameters of the bar code model for selected bar code types
LIntExport void SetBarCodeParamSpecific(const HTuple& BarCodeHandle, const HTuple& CodeTypes, const HTuple& GenParamName, const HTuple& GenParamValue);

// Set selected parameters of the bar code model.
LIntExport void SetBarCodeParam(const HTuple& BarCodeHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
...
LIntExport void CreateBarCodeModel(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* BarCodeHandle);
...
LIntExport void ControlIoChannel(const HTuple& IOChannelHandle, const HTuple& ParamAction, const HTuple& ParamArgument, HTuple* GenParamValue);
...
LIntExport void SetIoChannelParam(const HTuple& IOChannelHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Query specific parameters of I/O channels.
LIntExport void GetIoChannelParam(const HTuple& IOChannelHandle, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport void SetIoDeviceParam(const HTuple& IODeviceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Query settings of an I/O device instance. 
LIntExport void GetIoDeviceParam(const HTuple& IODeviceHandle, const HTuple& GenParamName, HTuple* GenParamValue);
...
LIntExport void AddScene3dLabel(const HTuple& Scene3D, const HTuple& Text, const HTuple& ReferencePoint, const HTuple& Position, const HTuple& RelatesTo, HTuple* LabelIndex);

// Remove a text label from a 3D scene.
LIntExport void RemoveScene3dLabel(const HTuple& Scene3D, const HTuple& LabelIndex);

// Set parameters of a text label in a 3D scene.
LIntExport void SetScene3dLabelParam(const HTuple& Scene3D, const HTuple& LabelIndex, const HTuple& GenParamName, const HTuple& GenParamValue);

// Add training images to the texture inspection model.
LIntExport void AddTextureInspectionModelImage(const HObject& Image, const HTuple& TextureInspectionModel, HTuple* Indices);

// Inspection of the texture within an image.
LIntExport void ApplyTextureInspectionModel(const HObject& Image, HObject* NoveltyRegion, const HTuple& TextureInspectionModel, HTuple* TextureInspectionResultID);

// bilateral filtering of an image.
LIntExport void BilateralFilter(const HObject& Image, const HObject& ImageJoint, HObject* ImageBilateral, const HTuple& SigmaSpatial, const HTuple& SigmaRange, const HTuple& GenParamName, const HTuple& GenParamValue);

// Clear an CNN-based OCR classifier.
LIntExport void ClearOcrClassCnn(const HTuple& OCRHandle);

// Clear a texture inspection model and free the allocated memory.
LIntExport void ClearTextureInspectionModel(const HTuple& TextureInspectionModel);

// Clear a texture inspection result handle and free the allocated memory. 
LIntExport void ClearTextureInspectionResult(const HTuple& TextureInspectionResultID);

// Convert image coordinates to window coordinates
LIntExport void ConvertCoordinatesImageToWindow(const HTuple& WindowHandle, const HTuple& RowImage, const HTuple& ColumnImage, HTuple* RowWindow, HTuple* ColumnWindow);

// Convert window coordinates to image coordinates
LIntExport void ConvertCoordinatesWindowToImage(const HTuple& WindowHandle, const HTuple& RowWindow, const HTuple& ColumnWindow, HTuple* RowImage, HTuple* ColumnImage);

// Create a texture inspection model.
LIntExport void CreateTextureInspectionModel(const HTuple& ModelType, HTuple* TextureInspectionModel);

// Deserialize a serialized dual quaternion.
LIntExport void DeserializeDualQuat(const HTuple& SerializedItemHandle, HTuple* DualQuaternion);

// Deserialize a serialized CNN-based OCR classifier.
LIntExport void DeserializeOcrClassCnn(const HTuple& SerializedItemHandle, HTuple* OCRHandle);

// Deserialize a serialized texture inspection model.
LIntExport void DeserializeTextureInspectionModel(const HTuple& SerializedItemHandle, HTuple* TextureInspectionModel);

// Display text in a window.
LIntExport void DispText(const HTuple& WindowHandle, const HTuple& String, const HTuple& CoordSystem, const HTuple& Row, const HTuple& Column, const HTuple& Color, const HTuple& GenParamName, const HTuple& GenParamValue);

// Classify multiple characters with an CNN-based OCR classifier.
LIntExport void DoOcrMultiClassCnn(const HObject& Character, const HObject& Image, const HTuple& OCRHandle, HTuple* Class, HTuple* Confidence);

// Classify a single character with an CNN-based OCR classifier.
LIntExport void DoOcrSingleClassCnn(const HObject& Character, const HObject& Image, const HTuple& OCRHandle, const HTuple& Num, HTuple* Class, HTuple* Confidence);

// Classify a related group of characters with an CNN-based OCR classifier.
LIntExport void DoOcrWordCnn(const HObject& Character, const HObject& Image, const HTuple& OCRHandle, const HTuple& Expression, const HTuple& NumAlternatives, const HTuple& NumCorrections, HTuple* Class, HTuple* Confidence, HTuple* Word, HTuple* Score);

// Multiply two dual quaternions.
LIntExport void DualQuatCompose(const HTuple& DualQuaternionLeft, const HTuple& DualQuaternionRight, HTuple* DualQuaternionComposed);

// Conjugate a dual quaternion.
LIntExport void DualQuatConjugate(const HTuple& DualQuaternion, HTuple* DualQuaternionConjugate);

// Interpolate two dual quaternions.
LIntExport void DualQuatInterpolate(const HTuple& DualQuaternionStart, const HTuple& DualQuaternionEnd, const HTuple& InterpPos, HTuple* DualQuaternionInterpolated);

// Normalize a dual quaternion.
LIntExport void DualQuatNormalize(const HTuple& DualQuaternion, HTuple* DualQuaternionNormalized);

// Convert a unit dual quaternion into a homogeneous transformation matrix.
LIntExport void DualQuatToHomMat3d(const HTuple& DualQuaternion, HTuple* HomMat3D);

// Convert a dual quaternion to a 3D pose.
LIntExport void DualQuatToPose(const HTuple& DualQuaternion, HTuple* Pose);

// Convert a unit dual quaternion into a screw.
LIntExport void DualQuatToScrew(const HTuple& DualQuaternion, const HTuple& ScrewFormat, HTuple* AxisDirectionX, HTuple* AxisDirectionY, HTuple* AxisDirectionZ, HTuple* AxisMomentOrPointX, HTuple* AxisMomentOrPointY, HTuple* AxisMomentOrPointZ, HTuple* Rotation, HTuple* Translation);

// Transform a 3D line with a unit dual quaternion.
LIntExport void DualQuatTransLine3d(const HTuple& DualQuaternion, const HTuple& LineFormat, const HTuple& LineDirectionX, const HTuple& LineDirectionY, const HTuple& LineDirectionZ, const HTuple& LineMomentOrPointX, const HTuple& LineMomentOrPointY, const HTuple& LineMomentOrPointZ, HTuple* TransLineDirectionX, HTuple* TransLineDirectionY, HTuple* TransLineDirectionZ, HTuple* TransLineMomentOrPointX, HTuple* TransLineMomentOrPointY, HTuple* TransLineMomentOrPointZ);

// Find edges in a 3D object model.
LIntExport void EdgesObjectModel3d(const HTuple& ObjectModel3D, const HTuple& MinAmplitude, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ObjectModel3DEdges);

// Find the best matches of multiple NCC models.
LIntExport void FindNccModels(const HObject& Image, const HTuple& ModelIDs, const HTuple& AngleStart, const HTuple& AngleExtent, const HTuple& MinScore, const HTuple& NumMatches, const HTuple& MaxOverlap, const HTuple& SubPixel, const HTuple& NumLevels, HTuple* Row, HTuple* Column, HTuple* Angle, HTuple* Score, HTuple* Model);

// Find the best matches of a surface model in a 3D scene and images.
LIntExport void FindSurfaceModelImage(const HObject& Image, const HTuple& SurfaceModelID, const HTuple& ObjectModel3D, const HTuple& RelSamplingDistance, const HTuple& KeyPointFraction, const HTuple& MinScore, const HTuple& ReturnResultHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Pose, HTuple* Score, HTuple* SurfaceMatchingResultID);

// Flush the contents of a window.
LIntExport void FlushBuffer(const HTuple& WindowHandle);

// Return the region used to create an NCC model.
LIntExport void GetNccModelRegion(HObject* ModelRegion, const HTuple& ModelID);

// Return the parameters of a CNN-based OCR classifier.
LIntExport void GetParamsOcrClassCnn(const HTuple& OCRHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Get the current color in RGBA-coding.
LIntExport void GetRgba(const HTuple& WindowHandle, HTuple* Red, HTuple* Green, HTuple* Blue, HTuple* Alpha);

// Get intermediate 3D object model of a stereo reconstruction
LIntExport void GetStereoModelObjectModel3d(const HTuple& StereoModelID, const HTuple& GenParamName, HTuple* ObjectModel3D);

// Get the training images contained in a texture inspection model.
LIntExport void GetTextureInspectionModelImage(HObject* ImageOut, const HTuple& TextureInspectionModel);

// Query parameters of a texture inspection model.
LIntExport void GetTextureInspectionModelParam(const HTuple& TextureInspectionModel, const HTuple& GenParamName, HTuple* GenParamValue);

// Query iconic results of a texture inspection.
LIntExport void GetTextureInspectionResultObject(HObject* Object, const HTuple& TextureInspectionResultID, const HTuple& ResultName);

// Guided filtering of an image.
LIntExport void GuidedFilter(const HObject& Image, const HObject& ImageGuide, HObject* ImageGuided, const HTuple& Radius, const HTuple& Amplitude);

// Create an interleaved image from a multichannel image.
LIntExport void InterleaveChannels(const HObject& MultichannelImage, HObject* InterleavedImage, const HTuple& PixelFormat, const HTuple& RowBytes, const HTuple& Alpha);

// Convert a 3D pose to a unit dual quaternion.
LIntExport void PoseToDualQuat(const HTuple& Pose, HTuple* DualQuaternion);

// Get the names of the parameters that can be used in get_params_ocr_class_cnn for a given CNN-based OCR classifier.
LIntExport void QueryParamsOcrClassCnn(const HTuple& OCRHandle, HTuple* GenParamName);

// Read an CNN-based OCR classifier from a file.
LIntExport void ReadOcrClassCnn(const HTuple& FileName, HTuple* OCRHandle);

// Read a texture inspection model from a file.
LIntExport void ReadTextureInspectionModel(const HTuple& FileName, HTuple* TextureInspectionModel);

// Refine the pose of a surface model in a 3D scene and in images.
LIntExport void RefineSurfaceModelPoseImage(const HObject& Image, const HTuple& SurfaceModelID, const HTuple& ObjectModel3D, const HTuple& InitialPose, const HTuple& MinScore, const HTuple& ReturnResultHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Pose, HTuple* Score, HTuple* SurfaceMatchingResultID);

// Clear all or a user-defined subset of the images of a texture inspection model.
LIntExport void RemoveTextureInspectionModelImage(const HTuple& TextureInspectionModel, const HTuple& Indices, HTuple* RemainingIndices);

// Convert a screw into a dual quaternion.
LIntExport void ScrewToDualQuat(const HTuple& ScrewFormat, const HTuple& AxisDirectionX, const HTuple& AxisDirectionY, const HTuple& AxisDirectionZ, const HTuple& AxisMomentOrPointX, const HTuple& AxisMomentOrPointY, const HTuple& AxisMomentOrPointZ, const HTuple& Rotation, const HTuple& Translation, HTuple* DualQuaternion);

// Segment image using Maximally Stable Extremal Regions (MSER).
LIntExport void SegmentImageMser(const HObject& Image, HObject* MSERDark, HObject* MSERLight, const HTuple& Polarity, const HTuple& MinArea, const HTuple& MaxArea, const HTuple& Delta, const HTuple& GenParamName, const HTuple& GenParamValue);

// Send an event to a buffer window signaling a mouse double click event.
LIntExport void SendMouseDoubleClickEvent(const HTuple& WindowHandle, const HTuple& Row, const HTuple& Column, const HTuple& Button, HTuple* Processed);

// Send an event to a window buffer signaling a mouse down event.
LIntExport void SendMouseDownEvent(const HTuple& WindowHandle, const HTuple& Row, const HTuple& Column, const HTuple& Button, HTuple* Processed);

// Send an event to a buffer window signaling a mouse drag event.
LIntExport void SendMouseDragEvent(const HTuple& WindowHandle, const HTuple& Row, const HTuple& Column, const HTuple& Button, HTuple* Processed);

// Send an event to a buffer window signaling a mouse up event.
LIntExport void SendMouseUpEvent(const HTuple& WindowHandle, const HTuple& Row, const HTuple& Column, const HTuple& Button, HTuple* Processed);

// Serialize a dual quaternion.
LIntExport void SerializeDualQuat(const HTuple& DualQuaternion, HTuple* SerializedItemHandle);

// Serialize a CNN-based OCR classifier
LIntExport void SerializeOcrClassCnn(const HTuple& OCRHandle, HTuple* SerializedItemHandle);

// Serialize a texture inspection model.
LIntExport void SerializeTextureInspectionModel(const HTuple& TextureInspectionModel, HTuple* SerializedItemHandle);

// Sets the callback for content updates in buffer window.
LIntExport void SetContentUpdateCallback(const HTuple& WindowHandle, const HTuple& CallbackFunction, const HTuple& CallbackContext);

// Set the color definition via RGBA values.
LIntExport void SetRgba(const HTuple& WindowHandle, const HTuple& Red, const HTuple& Green, const HTuple& Blue, const HTuple& Alpha);

// Set parameters and properties of a surface model.
LIntExport void SetSurfaceModelParam(const HTuple& SurfaceModelID, const HTuple& GenParamName, const HTuple& GenParamValue);

// Set parameters of a texture inspection model.
LIntExport void SetTextureInspectionModelParam(const HTuple& TextureInspectionModel, const HTuple& GenParamName, const HTuple& GenParamValue);

// Train a texture inspection model.
LIntExport void TrainTextureInspectionModel(const HTuple& TextureInspectionModel);

// Write a texture inspection model to a file.
LIntExport void WriteTextureInspectionModel(const HTuple& TextureInspectionModel, const HTuple& FileName);

// Reconstruct a surface from several, differently illuminated images.
LIntExport void UncalibratedPhotometricStereo(const HObject& Images, HObject* NormalField, HObject* Gradient, HObject* Albedo, const HTuple& ResultType);

// Infer the class affiliations for a set of images using a  deep-learning-based classifier.
LIntExport void ApplyDlClassifier(const HObject& Images, const HTuple& DLClassifierHandle, HTuple* DLClassifierResultHandle);

// Clear a deep-learning-based classifier.
LIntExport void ClearDlClassifier(const HTuple& DLClassifierHandle);

// Clear a handle containing the results of the deep-learning-based classification.
LIntExport void ClearDlClassifierResult(const HTuple& DLClassifierResultHandle);

// Clear the handle of a deep-learning-based classifier training result.
LIntExport void ClearDlClassifierTrainResult(const HTuple& DLClassifierTrainResultHandle);

// Clear a structured light model and free the allocated memory.
LIntExport void ClearStructuredLightModel(const HTuple& StructuredLightModel);

// Create a structured light model.
LIntExport void CreateStructuredLightModel(const HTuple& ModelType, HTuple* StructuredLightModel);

// Decode the camera images acquired with a structured light setup.
LIntExport void DecodeStructuredLightPattern(const HObject& CameraImages, const HTuple& StructuredLightModel);

// Deserialize a deep-learning-based classifier.
LIntExport void DeserializeDlClassifier(const HTuple& SerializedItemHandle, HTuple* DLClassifierHandle);

// Deserialize a structured light model.
LIntExport void DeserializeStructuredLightModel(const HTuple& SerializedItemHandle, HTuple* StructuredLightModel);

// Calculate the minimum distance between two contours and the points used for  the calculation.
LIntExport void DistanceCcMinPoints(const HObject& Contour1, const HObject& Contour2, const HTuple& Mode, HTuple* DistanceMin, HTuple* Row1, HTuple* Column1, HTuple* Row2, HTuple* Column2);

// Fuse 3D object models into a surface.
LIntExport void FuseObjectModel3d(const HTuple& ObjectModel3D, const HTuple& BoundingBox, const HTuple& Resolution, const HTuple& SurfaceTolerance, const HTuple& MinThickness, const HTuple& Smoothing, const HTuple& NormalDirection, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ObjectModel3DFusion);

// Generate the pattern images to be displayed in a structured light setup.
LIntExport void GenStructuredLightPattern(HObject* PatternImages, const HTuple& StructuredLightModel);

// Return the parameters of a deep-learning-based classifier.
LIntExport void GetDlClassifierParam(const HTuple& DLClassifierHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Retrieve classification results inferred by a deep-learning-based  classifier.
LIntExport void GetDlClassifierResult(const HTuple& DLClassifierResultHandle, const HTuple& Index, const HTuple& GenResultName, HTuple* GenResultValue);

// Return the results for the single training step of a deep-learning-based  classifier.
LIntExport void GetDlClassifierTrainResult(const HTuple& DLClassifierTrainResultHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Query parameters of a structured light model.
LIntExport void GetStructuredLightModelParam(const HTuple& StructuredLightModel, const HTuple& GenParamName, HTuple* GenParamValue);

// Get (intermediate) iconic results of a structured light model.
LIntExport void GetStructuredLightObject(HObject* Object, const HTuple& StructuredLightModel, const HTuple& ObjectName);

// Compute the width, height, and aspect ratio of the surrounding rectangle parallel to the coordinate axes.
LIntExport void HeightWidthRatio(const HObject& Regions, HTuple* Height, HTuple* Width, HTuple* Ratio);
...
LIntExport void HeightWidthRatioXld(const HObject& XLD, HTuple* Height, HTuple* Width, HTuple* Ratio);

// Insert objects into an iconic object tuple.
LIntExport void InsertObj(const HObject& Objects, const HObject& ObjectsInsert, HObject* ObjectsExtended, const HTuple& Index);

// Read a deep-learning-based classifier from a file.
LIntExport void ReadDlClassifier(const HTuple& FileName, HTuple* DLClassifierHandle);

// Read a structured light model from a file.
LIntExport void ReadStructuredLightModel(const HTuple& FileName, HTuple* StructuredLightModel);

// Remove objects from an iconic object tuple.
LIntExport void RemoveObj(const HObject& Objects, HObject* ObjectsReduced, const HTuple& Index);

// Replaces one or more elements of an iconic object tuple.
LIntExport void ReplaceObj(const HObject& Objects, const HObject& ObjectsReplace, HObject* Replaced, const HTuple& Index);

// Serialize a deep-learning-based classifier.
LIntExport void SerializeDlClassifier(const HTuple& DLClassifierHandle, HTuple* SerializedItemHandle);

// Serialize a structured light model.
LIntExport void SerializeStructuredLightModel(const HTuple& StructuredLightModel, HTuple* SerializedItemHandle);

// Set the parameters of a deep-learning-based classifier.
LIntExport void SetDlClassifierParam(const HTuple& DLClassifierHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Set a timeout for an operator. 
LIntExport void SetOperatorTimeout(const HTuple& OperatorName, const HTuple& Timeout, const HTuple& Mode);

// Set parameters of a structured light model.
LIntExport void SetStructuredLightModelParam(const HTuple& StructuredLightModel, const HTuple& GenParamName, const HTuple& GenParamValue);

// Perform a training step of a deep-learning-based classifier on a batch of  images.
LIntExport void TrainDlClassifierBatch(const HObject& BatchImages, const HTuple& DLClassifierHandle, const HTuple& BatchLabels, HTuple* DLClassifierTrainResultHandle);

// Write a deep-learning-based classifier in a file.
LIntExport void WriteDlClassifier(const HTuple& DLClassifierHandle, const HTuple& FileName);

// Write a structured light model to a file.
LIntExport void WriteStructuredLightModel(const HTuple& StructuredLightModel, const HTuple& FileName);

// Clear the content of a handle. 
LIntExport void ClearHandle(const HTuple& Handle);

// Deserialize a serialized item. 
LIntExport void DeserializeHandle(const HTuple& SerializedItem, HTuple* Handle);

// Convert a handle into an integer. 
LIntExport void HandleToInteger(const HTuple& Handle, HTuple* CastedHandle);

// Convert an integer into a handle. 
LIntExport void IntegerToHandle(const HTuple& IntegerHandle, HTuple* Handle);

// Serialize the content of a handle. 
LIntExport void SerializeHandle(const HTuple& Handle, HTuple* SerializedItem);

// Test if the internal representation of a tuple is of type handle.
LIntExport void TupleIsHandle(const HTuple& T, HTuple* IsHandle);

// Test whether the elements of a tuple are of type handle.
LIntExport void TupleIsHandleElem(const HTuple& T, HTuple* IsHandle);

// Test if a tuple is serializable.
LIntExport void TupleIsSerializable(const HTuple& Tuple, HTuple* IsSerializable);

// Test if the elements of a tuple are serializable.
LIntExport void TupleIsSerializableElem(const HTuple& Tuple, HTuple* IsSerializableElem);

// Check if a handle is valid. 
LIntExport void TupleIsValidHandle(const HTuple& Handle, HTuple* IsValid);

// Return the semantic type of a tuple.
LIntExport void TupleSemType(const HTuple& T, HTuple* SemType);

// Return the semantic type of the elements of a tuple.
LIntExport void TupleSemTypeElem(const HTuple& T, HTuple* SemTypes);

// Apply a deep-learning-based network on a set of images for inference.
LIntExport void ApplyDlModel(const HTuple& DLModelHandle, const HTuple& DLSampleBatch, const HTuple& Outputs, HTuple* DLResultBatch);

// Clear a deep learning model.
LIntExport void ClearDlModel(const HTuple& DLModelHandle);

// Copy a dictionary.
LIntExport void CopyDict(const HTuple& DictHandle, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* CopiedDictHandle);

// Create a new empty dictionary.
LIntExport void CreateDict(HTuple* DictHandle);

// Create a deep learning network for object detection.
LIntExport void CreateDlModelDetection(const HTuple& Backbone, const HTuple& NumClasses, const HTuple& DLModelDetectionParam, HTuple* DLModelHandle);

// Deserialize a deep learning model.
LIntExport void DeserializeDlModel(const HTuple& SerializedItemHandle, HTuple* DLModelHandle);

// Return the HALCON thread ID of the current thread.
LIntExport void GetCurrentHthreadId(HTuple* HThreadID);

// Retrieve an object associated with the key from the dictionary.
LIntExport void GetDictObject(HObject* Object, const HTuple& DictHandle, const HTuple& Key);

// Query dictionary parameters or information about a dictionary.
LIntExport void GetDictParam(const HTuple& DictHandle, const HTuple& GenParamName, const HTuple& Key, HTuple* GenParamValue);

// Retrieve a tuple associated with the key from the dictionary.
LIntExport void GetDictTuple(const HTuple& DictHandle, const HTuple& Key, HTuple* Tuple);

// Return the parameters of a deep learning model.
LIntExport void GetDlModelParam(const HTuple& DLModelHandle, const HTuple& GenParamName, HTuple* GenParamValue);

// Retrieve an object associated with a key from a handle. 
LIntExport void GetHandleObject(HObject* Object, const HTuple& Handle, const HTuple& Key);

// Return information about a handle. 
LIntExport void GetHandleParam(const HTuple& Handle, const HTuple& GenParamName, const HTuple& Key, HTuple* GenParamValue);

// Retrieve a tuple associated with a key from a handle. 
LIntExport void GetHandleTuple(const HTuple& Handle, const HTuple& Key, HTuple* Tuple);

// Get current value of system information without requiring a license.
LIntExport void GetSystemInfo(const HTuple& Query, HTuple* Information);

// Attempt to interrupt an operator running in a different thread.
LIntExport void InterruptOperator(const HTuple& HThreadID, const HTuple& Mode);

// Read a dictionary from a file.
LIntExport void ReadDict(const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DictHandle);

// Read a deep learning model from a file.
LIntExport void ReadDlModel(const HTuple& FileName, HTuple* DLModelHandle);

// Read a message from a file.
LIntExport void ReadMessage(const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* MessageHandle);

// Remove keys from a dictionary.
LIntExport void RemoveDictKey(const HTuple& DictHandle, const HTuple& Key);

// 
LIntExport void SendKeyPressEvent(const HTuple& WindowHandle, const HTuple& Char, const HTuple& Code);

// 
LIntExport void SendKeyReleaseEvent(const HTuple& WindowHandle, const HTuple& Char, const HTuple& Code);

// Serialize a deep learning model.
LIntExport void SerializeDlModel(const HTuple& DLModelHandle, HTuple* SerializedItemHandle);

// Add a key/object pair to the dictionary.
LIntExport void SetDictObject(const HObject& Object, const HTuple& DictHandle, const HTuple& Key);

// Add a key/tuple pair to the dictionary.
LIntExport void SetDictTuple(const HTuple& DictHandle, const HTuple& Key, const HTuple& Tuple);

// Set the parameters of a deep learning model.
LIntExport void SetDlModelParam(const HTuple& DLModelHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Train a deep learning model.
LIntExport void TrainDlModelBatch(const HTuple& DLModelHandle, const HTuple& DLSampleBatch, HTuple* DLTrainResult);

// Write a dictionary to a file.
LIntExport void WriteDict(const HTuple& DictHandle, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue);

// Write a deep learning model in a file.
LIntExport void WriteDlModel(const HTuple& DLModelHandle, const HTuple& FileName);

// Write a message to a file.
LIntExport void WriteMessage(const HTuple& MessageHandle, const HTuple& FileName, const HTuple& GenParamName, const HTuple& GenParamValue);

// Calculate the intersection area of oriented rectangles.
LIntExport void AreaIntersectionRectangle2(const HTuple& Rect1Row, const HTuple& Rect1Column, const HTuple& Rect1Phi, const HTuple& Rect1Length1, const HTuple& Rect1Length2, const HTuple& Rect2Row, const HTuple& Rect2Column, const HTuple& Rect2Phi, const HTuple& Rect2Length1, const HTuple& Rect2Length2, HTuple* AreaIntersection);

// Get the current contour display fill style.
LIntExport void GetContourStyle(const HTuple& WindowHandle, HTuple* Style);

// Get the clutter parameters of a shape model.
LIntExport void GetShapeModelClutter(HObject* ClutterRegion, const HTuple& ModelID, const HTuple& GenParamName, HTuple* GenParamValue, HTuple* HomMat2D, HTuple* ClutterContrast);

// Define the contour display fill style.
LIntExport void SetContourStyle(const HTuple& WindowHandle, const HTuple& Style);

//  Set the clutter parameters of a shape model.
LIntExport void SetShapeModelClutter(const HObject& ClutterRegion, const HTuple& ModelID, const HTuple& HomMat2D, const HTuple& ClutterContrast, const HTuple& GenParamName, const HTuple& GenParamValue);

// Find boxes in 3D data.
LIntExport void FindBox3d(const HTuple& ObjectModel3DScene, const HTuple& SideLen1, const HTuple& SideLen2, const HTuple& SideLen3, const HTuple& MinScore, const HTuple& GenParam, HTuple* GrippingPose, HTuple* Score, HTuple* ObjectModel3DBox, HTuple* BoxInformation);

// Read bytes from a binary file.
LIntExport void FreadBytes(const HTuple& FileHandle, const HTuple& NumberOfBytes, HTuple* ReadData, HTuple* IsEOF);

// Write bytes to a binary file.
LIntExport void FwriteBytes(const HTuple& FileHandle, const HTuple& DataToWrite, HTuple* NumberOfBytesWritten);

// Infer the sample and generate a heatmap.
LIntExport void GenDlModelHeatmap(const HTuple& DLModelHandle, const HTuple& DLSample, const HTuple& HeatmapMethod, const HTuple& TargetClasses, const HTuple& GenParam, HTuple* DLResult);

// Read metadata from image files.
LIntExport void ReadImageMetadata(const HTuple& Format, const HTuple& TagName, const HTuple& FileName, HTuple* TagValue);

// Shape factor for the rectangularity of contours or polygons.
LIntExport void RectangularityXld(const HObject& XLD, HTuple* Rectangularity);

// Remove attributes of a 3D object model.
LIntExport void RemoveObjectModel3dAttrib(const HTuple& ObjectModel3D, const HTuple& Attributes, HTuple* ObjectModel3DOut);

// Remove attributes of a 3D object model.
LIntExport void RemoveObjectModel3dAttribMod(const HTuple& ObjectModel3D, const HTuple& Attributes);

// Train a deep learning model for anomaly detection.
LIntExport void TrainDlModelAnomalyDataset(const HTuple& DLModelHandle, const HTuple& DLSamples, const HTuple& DLTrainParam, HTuple* DLTrainResult);

// Extract watersheds and combine basins based on markers.
LIntExport void WatershedsMarker(const HObject& Image, const HObject& Markers, HObject* Basins);

// Write metadata of image files.
LIntExport void WriteImageMetadata(const HTuple& Format, const HTuple& TagName, const HTuple& TagValue, const HTuple& FileName);
