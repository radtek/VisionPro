...
LIntExport Herror T_affine_trans_polygon_xld(const Hobject Polygons, Hobject *PolygonsAffineTrans, const Htuple HomMat2D);
LIntExport Herror T_affine_trans_contour_xld(const Hobject Contours, Hobject *ContoursAffineTrans, const Htuple HomMat2D);
...
LIntExport Herror T_create_scattered_data_interpolator(const Htuple Method, const Htuple Rows, const Htuple Columns, const Htuple Values, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ScatteredDataInterpolatorHandle);
LIntExport Herror T_interpolate_scattered_data_points_to_image(Hobject *ImageInterpolated, const Htuple Method, const Htuple Rows, const Htuple Columns, const Htuple Values, const Htuple Width, const Htuple Height, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_interpolate_scattered_data_image(const Hobject Image, const Hobject RegionInterpolate, Hobject *ImageInterpolated, const Htuple Method, const Htuple GenParamName, const Htuple GenParamValue);
...
LIntExport Herror T_get_compute_device_param(const Htuple DeviceHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_compute_device_param(Hlong DeviceHandle, const char *GenParamName, char *GenParamValue);
LIntExport Herror T_set_compute_device_param(const Htuple DeviceHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_compute_device_param(Hlong DeviceHandle, const char *GenParamName, const char *GenParamValue);
...
LIntExport Herror T_get_socket_param(const Htuple Socket, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_socket_param(Hlong Socket, const char *GenParamName, char *GenParamValue);
LIntExport Herror T_set_socket_param(const Htuple Socket, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_socket_param(Hlong Socket, const char *GenParamName, const char *GenParamValue);
...
LIntExport Herror T_query_sheet_of_light_params(const Htuple SheetOfLightModelID, const Htuple QueryName, Htuple *GenParamName);
...
LIntExport Herror T_create_sheet_of_light_model(const Hobject ProfileRegion, const Htuple GenParamName, const Htuple GenParamValue, Htuple *SheetOfLightModelID);
LIntExport Herror create_sheet_of_light_model(const Hobject ProfileRegion, const char *GenParamName, Hlong GenParamValue, Hlong *SheetOfLightModelID);
...
LIntExport Herror T_fit_primitives_object_model_3d(const Htuple ObjectModel3D, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ObjectModel3DOut);
LIntExport Herror T_segment_object_model_3d(const Htuple ObjectModel3D, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ObjectModel3DOut);
...
LIntExport Herror T_create_text_model_reader(const Htuple Mode, const Htuple OCRClassifier, Htuple *TextModel);
LIntExport Herror create_text_model_reader(const char *Mode, const char *OCRClassifier, Hlong *TextModel);
...
LIntExport Herror T_regiongrowing(const Hobject Image, Hobject *Regions, const Htuple RasterHeight, const Htuple RasterWidth, const Htuple Tolerance, const Htuple MinSize);
LIntExport Herror regiongrowing(const Hobject Image, Hobject *Regions, Hlong RasterHeight, Hlong RasterWidth, double Tolerance, Hlong MinSize);
...
LIntExport Herror T_get_stereo_model_param(const Htuple StereoModelID, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_set_stereo_model_param(const Htuple StereoModelID, const Htuple GenParamName, const Htuple GenParamValue);
...
LIntExport Herror T_optimize_aop(const Htuple OperatorName, const Htuple IconicType, const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_write_aop_knowledge(const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror write_aop_knowledge(const char *FileName, const char *GenParamName, const char *GenParamValue);
LIntExport Herror T_read_aop_knowledge(const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Attributes, Htuple *OperatorNames);
...
LIntExport Herror T_create_ocr_class_knn(const Htuple WidthCharacter, const Htuple HeightCharacter, const Htuple Interpolation, const Htuple Features, const Htuple Characters, const Htuple GenParamName, const Htuple GenParamValue, Htuple *OCRHandle);
LIntExport Herror T_trainf_ocr_class_knn(const Htuple OCRHandle, const Htuple TrainingFile, const Htuple GenParamName, const Htuple GenParamValue);
...
LIntExport Herror T_select_feature_set_trainf_knn(const Htuple TrainingFile, const Htuple FeatureList, const Htuple SelectionMethod, const Htuple Width, const Htuple Height, const Htuple GenParamName, const Htuple GenParamValue, Htuple *OCRHandle, Htuple *FeatureSet, Htuple *Score);
LIntExport Herror T_select_feature_set_trainf_mlp_protected(const Htuple TrainingFile, const Htuple Password, const Htuple FeatureList, const Htuple SelectionMethod, const Htuple Width, const Htuple Height, const Htuple GenParamName, const Htuple GenParamValue, Htuple *OCRHandle, Htuple *FeatureSet, Htuple *Score);
LIntExport Herror T_select_feature_set_trainf_mlp(const Htuple TrainingFile, const Htuple FeatureList, const Htuple SelectionMethod, const Htuple Width, const Htuple Height, const Htuple GenParamName, const Htuple GenParamValue, Htuple *OCRHandle, Htuple *FeatureSet, Htuple *Score);
LIntExport Herror T_select_feature_set_trainf_svm_protected(const Htuple TrainingFile, const Htuple Password, const Htuple FeatureList, const Htuple SelectionMethod, const Htuple Width, const Htuple Height, const Htuple GenParamName, const Htuple GenParamValue, Htuple *OCRHandle, Htuple *FeatureSet, Htuple *Score);
LIntExport Herror T_select_feature_set_trainf_svm(const Htuple TrainingFile, const Htuple FeatureList, const Htuple SelectionMethod, const Htuple Width, const Htuple Height, const Htuple GenParamName, const Htuple GenParamValue, Htuple *OCRHandle, Htuple *FeatureSet, Htuple *Score);
...
LIntExport Herror get_metrology_object_result_contour(Hobject *Contour, Hlong MetrologyHandle, Hlong Index, const char *Instance, double Resolution);
...
LIntExport Herror T_get_sample_identifier_param(const Htuple SampleIdentifier, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_sample_identifier_param(Hlong SampleIdentifier, const char *GenParamName, double *GenParamValue);
LIntExport Herror T_set_sample_identifier_param(const Htuple SampleIdentifier, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_sample_identifier_param(Hlong SampleIdentifier, const char *GenParamName, double GenParamValue);
...
LIntExport Herror T_train_sample_identifier(const Htuple SampleIdentifier, const Htuple GenParamName, const Htuple GenParamValue);
...
LIntExport Herror T_create_sample_identifier(const Htuple GenParamName, const Htuple GenParamValue, Htuple *SampleIdentifier);
...
LIntExport Herror T_set_shape_model_param(const Htuple ModelID, const Htuple GenParamName, const Htuple GenParamValue);
...
LIntExport Herror T_set_deformable_model_param(const Htuple ModelID, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_get_deformable_model_params(const Htuple ModelID, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_deformable_model_params(Hlong ModelID, const char *GenParamName, char *GenParamValue);
...
LIntExport Herror T_set_ncc_model_param(const Htuple ModelID, const Htuple GenParamName, const Htuple GenParamValue);
...
LIntExport Herror T_get_deformable_surface_model_param(const Htuple DeformableSurfaceModel, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_deformable_surface_model_param(Hlong DeformableSurfaceModel, const char *GenParamName, double *GenParamValue);
...
LIntExport Herror T_get_surface_model_param(const Htuple SurfaceModelID, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_surface_model_param(Hlong SurfaceModelID, const char *GenParamName, double *GenParamValue);
...
LIntExport Herror T_get_shape_model_3d_params(const Htuple ShapeModel3DID, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_shape_model_3d_params(Hlong ShapeModel3DID, const char *GenParamName, char *GenParamValue);
LIntExport Herror T_find_shape_model_3d(const Hobject Image, const Htuple ShapeModel3DID, const Htuple MinScore, const Htuple Greediness, const Htuple NumLevels, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Pose, Htuple *CovPose, Htuple *Score);
...
LIntExport Herror T_distance_object_model_3d(const Htuple ObjectModel3DFrom, const Htuple ObjectModel3DTo, const Htuple Pose, const Htuple MaxDistance, const Htuple GenParamName, const Htuple GenParamValue);
...
LIntExport Herror T_get_object_model_3d_params(const Htuple ObjectModel3D, const Htuple GenParamName, Htuple *GenParamValue);
...
LIntExport Herror T_set_drawing_object_callback(const Htuple DrawHandle, const Htuple DrawObjectEvent, const Htuple CallbackFunction);
LIntExport Herror set_drawing_object_callback(Hlong DrawHandle, const char *DrawObjectEvent, Hlong CallbackFunction);
...
LIntExport Herror T_detach_drawing_object_from_window(const Htuple WindowHandle, const Htuple DrawHandle);
LIntExport Herror detach_drawing_object_from_window(Hlong WindowHandle, Hlong DrawHandle);
LIntExport Herror T_attach_drawing_object_to_window(const Htuple WindowHandle, const Htuple DrawHandle);
LIntExport Herror attach_drawing_object_to_window(Hlong WindowHandle, Hlong DrawHandle);
...
LIntExport Herror get_window_param(Hlong WindowHandle, const char *Param, char *Value);
LIntExport Herror T_set_window_param(const Htuple WindowHandle, const Htuple Param, const Htuple Value);
LIntExport Herror set_window_param(Hlong WindowHandle, const char *Param, const char *Value);
...
LIntExport Herror set_line_width(Hlong WindowHandle, double Width);
...
LIntExport Herror get_line_width(Hlong WindowHandle, double *Width);
...
LIntExport Herror T_set_drawing_object_params(const Htuple DrawID, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_drawing_object_params(Hlong DrawID, const char *GenParamName, double GenParamValue);
LIntExport Herror T_get_drawing_object_params(const Htuple DrawID, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_drawing_object_params(Hlong DrawID, const char *GenParamName, double *GenParamValue);
...
LIntExport Herror T_affine_trans_image_size(const Hobject Image, Hobject *ImageAffineTrans, const Htuple HomMat2D, const Htuple Interpolation, const Htuple Width, const Htuple Height);
LIntExport Herror T_affine_trans_image(const Hobject Image, Hobject *ImageAffineTrans, const Htuple HomMat2D, const Htuple Interpolation, const Htuple AdaptImageSize);
...
LIntExport Herror T_read_polygon_xld_dxf(Hobject *Polygons, const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DxfStatus);
LIntExport Herror read_polygon_xld_dxf(Hobject *Polygons, const char *FileName, const char *GenParamName, double GenParamValue, char *DxfStatus);
...
LIntExport Herror T_read_contour_xld_dxf(Hobject *Contours, const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DxfStatus);
LIntExport Herror read_contour_xld_dxf(Hobject *Contours, const char *FileName, const char *GenParamName, double GenParamValue, char *DxfStatus);
...
LIntExport Herror line_position(double RowBegin, double ColBegin, double RowEnd, double ColEnd, double *RowCenter, double *ColCenter, double *Length, double *Phi);
...
LIntExport Herror T_find_data_code_2d(const Hobject Image, Hobject *SymbolXLDs, const Htuple DataCodeHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ResultHandles, Htuple *DecodedDataStrings);
LIntExport Herror find_data_code_2d(const Hobject Image, Hobject *SymbolXLDs, Hlong DataCodeHandle, const char *GenParamName, Hlong GenParamValue, Hlong *ResultHandles, char *DecodedDataStrings);
LIntExport Herror T_set_data_code_2d_param(const Htuple DataCodeHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_data_code_2d_param(Hlong DataCodeHandle, const char *GenParamName, const char *GenParamValue);
LIntExport Herror T_get_data_code_2d_param(const Htuple DataCodeHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_data_code_2d_param(Hlong DataCodeHandle, const char *GenParamName, char *GenParamValue);
LIntExport Herror T_query_data_code_2d_params(const Htuple DataCodeHandle, const Htuple QueryName, Htuple *GenParamName);
...
LIntExport Herror T_create_data_code_2d_model(const Htuple SymbolType, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DataCodeHandle);
LIntExport Herror create_data_code_2d_model(const char *SymbolType, const char *GenParamName, const char *GenParamValue, Hlong *DataCodeHandle);
...
LIntExport Herror T_select_feature_set_mlp(const Htuple ClassTrainDataHandle, const Htuple SelectionMethod, const Htuple GenParamName, const Htuple GenParamValue, Htuple *MLPHandle, Htuple *SelectedFeatureIndices, Htuple *Score);
LIntExport Herror T_select_feature_set_svm(const Htuple ClassTrainDataHandle, const Htuple SelectionMethod, const Htuple GenParamName, const Htuple GenParamValue, Htuple *SVMHandle, Htuple *SelectedFeatureIndices, Htuple *Score);
LIntExport Herror T_select_feature_set_gmm(const Htuple ClassTrainDataHandle, const Htuple SelectionMethod, const Htuple GenParamName, const Htuple GenParamValue, Htuple *GMMHandle, Htuple *SelectedFeatureIndices, Htuple *Score);
LIntExport Herror T_select_feature_set_knn(const Htuple ClassTrainDataHandle, const Htuple SelectionMethod, const Htuple GenParamName, const Htuple GenParamValue, Htuple *KNNHandle, Htuple *SelectedFeatureIndices, Htuple *Score);
...
LIntExport Herror T_get_params_class_knn(const Htuple KNNHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_set_params_class_knn(const Htuple KNNHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_classify_class_knn(const Htuple KNNHandle, const Htuple Features, Htuple *Result, Htuple *Rating);
LIntExport Herror T_train_class_knn(const Htuple KNNHandle, const Htuple GenParamName, const Htuple GenParamValue);
...
LIntExport Herror T_create_class_lut_knn(const Htuple KNNHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ClassLUTHandle);
LIntExport Herror T_create_class_lut_gmm(const Htuple GMMHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ClassLUTHandle);
LIntExport Herror T_create_class_lut_svm(const Htuple SVMHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ClassLUTHandle);
LIntExport Herror T_create_class_lut_mlp(const Htuple MLPHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ClassLUTHandle);
...
LIntExport Herror get_support_vector_class_svm(Hlong SVMHandle, Hlong IndexSupportVector, double *Index);
...
LIntExport Herror T_get_camera_setup_param(const Htuple CameraSetupModelID, const Htuple CameraIdx, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_camera_setup_param(Hlong CameraSetupModelID, Hlong CameraIdx, const char *GenParamName, double *GenParamValue);
LIntExport Herror T_set_camera_setup_param(const Htuple CameraSetupModelID, const Htuple CameraIdx, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_camera_setup_param(Hlong CameraSetupModelID, Hlong CameraIdx, const char *GenParamName, double GenParamValue);
...
LIntExport Herror T_get_bead_inspection_param(const Htuple BeadInspectionModel, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_bead_inspection_param(Hlong BeadInspectionModel, const char *GenParamName, Hlong *GenParamValue);
LIntExport Herror T_set_bead_inspection_param(const Htuple BeadInspectionModel, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_bead_inspection_param(Hlong BeadInspectionModel, const char *GenParamName, const char *GenParamValue);
...
LIntExport Herror T_create_bead_inspection_model(const Hobject BeadContour, const Htuple TargetThickness, const Htuple ThicknessTolerance, const Htuple PositionTolerance, const Htuple Polarity, const Htuple GenParamName, const Htuple GenParamValue, Htuple *BeadInspectionModel);
LIntExport Herror create_bead_inspection_model(const Hobject BeadContour, Hlong TargetThickness, Hlong ThicknessTolerance, Hlong PositionTolerance, const char *Polarity, const char *GenParamName, Hlong GenParamValue, Hlong *BeadInspectionModel);
...
LIntExport Herror T_query_bar_code_params(const Htuple BarCodeHandle, const Htuple Properties, Htuple *GenParamName);
LIntExport Herror query_bar_code_params(Hlong BarCodeHandle, const char *Properties, char *GenParamName);
LIntExport Herror T_get_bar_code_param_specific(const Htuple BarCodeHandle, const Htuple CodeTypes, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_bar_code_param_specific(Hlong BarCodeHandle, const char *CodeTypes, const char *GenParamName, double *GenParamValue);
LIntExport Herror T_get_bar_code_param(const Htuple BarCodeHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_bar_code_param(Hlong BarCodeHandle, const char *GenParamName, double *GenParamValue);
LIntExport Herror T_set_bar_code_param_specific(const Htuple BarCodeHandle, const Htuple CodeTypes, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_set_bar_code_param(const Htuple BarCodeHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_bar_code_param(Hlong BarCodeHandle, const char *GenParamName, double GenParamValue);
...
LIntExport Herror T_create_bar_code_model(const Htuple GenParamName, const Htuple GenParamValue, Htuple *BarCodeHandle);
LIntExport Herror create_bar_code_model(const char *GenParamName, double GenParamValue, Hlong *BarCodeHandle);
...
LIntExport Herror T_control_io_channel(const Htuple IOChannelHandle, const Htuple ParamAction, const Htuple ParamArgument, Htuple *GenParamValue);
...
LIntExport Herror T_set_io_channel_param(const Htuple IOChannelHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_get_io_channel_param(const Htuple IOChannelHandle, const Htuple GenParamName, Htuple *GenParamValue);
...
LIntExport Herror T_set_io_device_param(const Htuple IODeviceHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_io_device_param(Hlong IODeviceHandle, const char *GenParamName, const char *GenParamValue);
LIntExport Herror T_get_io_device_param(const Htuple IODeviceHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_io_device_param(Hlong IODeviceHandle, const char *GenParamName, char *GenParamValue);
...
LIntExport Herror T_add_scene_3d_label(const Htuple Scene3D, const Htuple Text, const Htuple ReferencePoint, const Htuple Position, const Htuple RelatesTo, Htuple *LabelIndex);
LIntExport Herror T_remove_scene_3d_label(const Htuple Scene3D, const Htuple LabelIndex);
LIntExport Herror remove_scene_3d_label(Hlong Scene3D, Hlong LabelIndex);
LIntExport Herror T_set_scene_3d_label_param(const Htuple Scene3D, const Htuple LabelIndex, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_add_texture_inspection_model_image(const Hobject Image, const Htuple TextureInspectionModel, Htuple *Indices);
LIntExport Herror add_texture_inspection_model_image(const Hobject Image, Hlong TextureInspectionModel, Hlong *Indices);
LIntExport Herror T_apply_texture_inspection_model(const Hobject Image, Hobject *NoveltyRegion, const Htuple TextureInspectionModel, Htuple *TextureInspectionResultID);
LIntExport Herror apply_texture_inspection_model(const Hobject Image, Hobject *NoveltyRegion, Hlong TextureInspectionModel, Hlong *TextureInspectionResultID);
LIntExport Herror T_bilateral_filter(const Hobject Image, const Hobject ImageJoint, Hobject *ImageBilateral, const Htuple SigmaSpatial, const Htuple SigmaRange, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror bilateral_filter(const Hobject Image, const Hobject ImageJoint, Hobject *ImageBilateral, double SigmaSpatial, double SigmaRange, const char *GenParamName, double GenParamValue);
LIntExport Herror T_clear_ocr_class_cnn(const Htuple OCRHandle);
LIntExport Herror clear_ocr_class_cnn(Hlong OCRHandle);
LIntExport Herror T_clear_texture_inspection_model(const Htuple TextureInspectionModel);
LIntExport Herror clear_texture_inspection_model(Hlong TextureInspectionModel);
LIntExport Herror T_clear_texture_inspection_result(const Htuple TextureInspectionResultID);
LIntExport Herror clear_texture_inspection_result(Hlong TextureInspectionResultID);
LIntExport Herror T_convert_coordinates_image_to_window(const Htuple WindowHandle, const Htuple RowImage, const Htuple ColumnImage, Htuple *RowWindow, Htuple *ColumnWindow);
LIntExport Herror convert_coordinates_image_to_window(Hlong WindowHandle, double RowImage, double ColumnImage, double *RowWindow, double *ColumnWindow);
LIntExport Herror T_convert_coordinates_window_to_image(const Htuple WindowHandle, const Htuple RowWindow, const Htuple ColumnWindow, Htuple *RowImage, Htuple *ColumnImage);
LIntExport Herror convert_coordinates_window_to_image(Hlong WindowHandle, double RowWindow, double ColumnWindow, double *RowImage, double *ColumnImage);
LIntExport Herror T_create_texture_inspection_model(const Htuple ModelType, Htuple *TextureInspectionModel);
LIntExport Herror create_texture_inspection_model(const char *ModelType, Hlong *TextureInspectionModel);
LIntExport Herror T_deserialize_dual_quat(const Htuple SerializedItemHandle, Htuple *DualQuaternion);
LIntExport Herror T_deserialize_ocr_class_cnn(const Htuple SerializedItemHandle, Htuple *OCRHandle);
LIntExport Herror deserialize_ocr_class_cnn(Hlong SerializedItemHandle, Hlong *OCRHandle);
LIntExport Herror T_deserialize_texture_inspection_model(const Htuple SerializedItemHandle, Htuple *TextureInspectionModel);
LIntExport Herror deserialize_texture_inspection_model(Hlong SerializedItemHandle, Hlong *TextureInspectionModel);
LIntExport Herror T_disp_text(const Htuple WindowHandle, const Htuple String, const Htuple CoordSystem, const Htuple Row, const Htuple Column, const Htuple Color, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_do_ocr_multi_class_cnn(const Hobject Character, const Hobject Image, const Htuple OCRHandle, Htuple *Class, Htuple *Confidence);
LIntExport Herror do_ocr_multi_class_cnn(const Hobject Character, const Hobject Image, Hlong OCRHandle, char *Class, double *Confidence);
LIntExport Herror T_do_ocr_single_class_cnn(const Hobject Character, const Hobject Image, const Htuple OCRHandle, const Htuple Num, Htuple *Class, Htuple *Confidence);
LIntExport Herror T_do_ocr_word_cnn(const Hobject Character, const Hobject Image, const Htuple OCRHandle, const Htuple Expression, const Htuple NumAlternatives, const Htuple NumCorrections, Htuple *Class, Htuple *Confidence, Htuple *Word, Htuple *Score);
LIntExport Herror do_ocr_word_cnn(const Hobject Character, const Hobject Image, Hlong OCRHandle, const char *Expression, Hlong NumAlternatives, Hlong NumCorrections, char *Class, double *Confidence, char *Word, double *Score);
LIntExport Herror T_dual_quat_compose(const Htuple DualQuaternionLeft, const Htuple DualQuaternionRight, Htuple *DualQuaternionComposed);
LIntExport Herror T_dual_quat_conjugate(const Htuple DualQuaternion, Htuple *DualQuaternionConjugate);
LIntExport Herror T_dual_quat_interpolate(const Htuple DualQuaternionStart, const Htuple DualQuaternionEnd, const Htuple InterpPos, Htuple *DualQuaternionInterpolated);
LIntExport Herror T_dual_quat_normalize(const Htuple DualQuaternion, Htuple *DualQuaternionNormalized);
LIntExport Herror T_dual_quat_to_hom_mat3d(const Htuple DualQuaternion, Htuple *HomMat3D);
LIntExport Herror T_dual_quat_to_pose(const Htuple DualQuaternion, Htuple *Pose);
LIntExport Herror T_dual_quat_to_screw(const Htuple DualQuaternion, const Htuple ScrewFormat, Htuple *AxisDirectionX, Htuple *AxisDirectionY, Htuple *AxisDirectionZ, Htuple *AxisMomentOrPointX, Htuple *AxisMomentOrPointY, Htuple *AxisMomentOrPointZ, Htuple *Rotation, Htuple *Translation);
LIntExport Herror T_dual_quat_trans_line_3d(const Htuple DualQuaternion, const Htuple LineFormat, const Htuple LineDirectionX, const Htuple LineDirectionY, const Htuple LineDirectionZ, const Htuple LineMomentOrPointX, const Htuple LineMomentOrPointY, const Htuple LineMomentOrPointZ, Htuple *TransLineDirectionX, Htuple *TransLineDirectionY, Htuple *TransLineDirectionZ, Htuple *TransLineMomentOrPointX, Htuple *TransLineMomentOrPointY, Htuple *TransLineMomentOrPointZ);
LIntExport Herror T_edges_object_model_3d(const Htuple ObjectModel3D, const Htuple MinAmplitude, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ObjectModel3DEdges);
LIntExport Herror edges_object_model_3d(Hlong ObjectModel3D, double MinAmplitude, const char *GenParamName, double GenParamValue, Hlong *ObjectModel3DEdges);
LIntExport Herror T_find_ncc_models(const Hobject Image, const Htuple ModelIDs, const Htuple AngleStart, const Htuple AngleExtent, const Htuple MinScore, const Htuple NumMatches, const Htuple MaxOverlap, const Htuple SubPixel, const Htuple NumLevels, Htuple *Row, Htuple *Column, Htuple *Angle, Htuple *Score, Htuple *Model);
LIntExport Herror T_find_surface_model_image(const Hobject Image, const Htuple SurfaceModelID, const Htuple ObjectModel3D, const Htuple RelSamplingDistance, const Htuple KeyPointFraction, const Htuple MinScore, const Htuple ReturnResultHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Pose, Htuple *Score, Htuple *SurfaceMatchingResultID);
LIntExport Herror T_flush_buffer(const Htuple WindowHandle);
LIntExport Herror flush_buffer(Hlong WindowHandle);
LIntExport Herror T_get_ncc_model_region(Hobject *ModelRegion, const Htuple ModelID);
LIntExport Herror get_ncc_model_region(Hobject *ModelRegion, Hlong ModelID);
LIntExport Herror T_get_params_ocr_class_cnn(const Htuple OCRHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_params_ocr_class_cnn(Hlong OCRHandle, const char *GenParamName, Hlong *GenParamValue);
LIntExport Herror T_get_rgba(const Htuple WindowHandle, Htuple *Red, Htuple *Green, Htuple *Blue, Htuple *Alpha);
LIntExport Herror T_get_stereo_model_object_model_3d(const Htuple StereoModelID, const Htuple GenParamName, Htuple *ObjectModel3D);
LIntExport Herror get_stereo_model_object_model_3d(Hlong StereoModelID, const char *GenParamName, Hlong *ObjectModel3D);
LIntExport Herror T_get_texture_inspection_model_image(Hobject *ImageOut, const Htuple TextureInspectionModel);
LIntExport Herror get_texture_inspection_model_image(Hobject *ImageOut, Hlong TextureInspectionModel);
LIntExport Herror T_get_texture_inspection_model_param(const Htuple TextureInspectionModel, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_texture_inspection_model_param(Hlong TextureInspectionModel, const char *GenParamName, Hlong *GenParamValue);
LIntExport Herror T_get_texture_inspection_result_object(Hobject *Object, const Htuple TextureInspectionResultID, const Htuple ResultName);
LIntExport Herror get_texture_inspection_result_object(Hobject *Object, Hlong TextureInspectionResultID, const char *ResultName);
LIntExport Herror T_guided_filter(const Hobject Image, const Hobject ImageGuide, Hobject *ImageGuided, const Htuple Radius, const Htuple Amplitude);
LIntExport Herror guided_filter(const Hobject Image, const Hobject ImageGuide, Hobject *ImageGuided, Hlong Radius, double Amplitude);
LIntExport Herror T_interleave_channels(const Hobject MultichannelImage, Hobject *InterleavedImage, const Htuple PixelFormat, const Htuple RowBytes, const Htuple Alpha);
LIntExport Herror interleave_channels(const Hobject MultichannelImage, Hobject *InterleavedImage, const char *PixelFormat, const char *RowBytes, Hlong Alpha);
LIntExport Herror T_pose_to_dual_quat(const Htuple Pose, Htuple *DualQuaternion);
LIntExport Herror T_query_params_ocr_class_cnn(const Htuple OCRHandle, Htuple *GenParamName);
LIntExport Herror query_params_ocr_class_cnn(Hlong OCRHandle, char *GenParamName);
LIntExport Herror T_read_ocr_class_cnn(const Htuple FileName, Htuple *OCRHandle);
LIntExport Herror read_ocr_class_cnn(const char *FileName, Hlong *OCRHandle);
LIntExport Herror T_read_texture_inspection_model(const Htuple FileName, Htuple *TextureInspectionModel);
LIntExport Herror read_texture_inspection_model(const char *FileName, Hlong *TextureInspectionModel);
LIntExport Herror T_refine_surface_model_pose_image(const Hobject Image, const Htuple SurfaceModelID, const Htuple ObjectModel3D, const Htuple InitialPose, const Htuple MinScore, const Htuple ReturnResultHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Pose, Htuple *Score, Htuple *SurfaceMatchingResultID);
LIntExport Herror T_remove_texture_inspection_model_image(const Htuple TextureInspectionModel, const Htuple Indices, Htuple *RemainingIndices);
LIntExport Herror T_screw_to_dual_quat(const Htuple ScrewFormat, const Htuple AxisDirectionX, const Htuple AxisDirectionY, const Htuple AxisDirectionZ, const Htuple AxisMomentOrPointX, const Htuple AxisMomentOrPointY, const Htuple AxisMomentOrPointZ, const Htuple Rotation, const Htuple Translation, Htuple *DualQuaternion);
LIntExport Herror T_segment_image_mser(const Hobject Image, Hobject *MSERDark, Hobject *MSERLight, const Htuple Polarity, const Htuple MinArea, const Htuple MaxArea, const Htuple Delta, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_send_mouse_double_click_event(const Htuple WindowHandle, const Htuple Row, const Htuple Column, const Htuple Button, Htuple *Processed);
LIntExport Herror send_mouse_double_click_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, char *Processed);
LIntExport Herror T_send_mouse_down_event(const Htuple WindowHandle, const Htuple Row, const Htuple Column, const Htuple Button, Htuple *Processed);
LIntExport Herror send_mouse_down_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, char *Processed);
LIntExport Herror T_send_mouse_drag_event(const Htuple WindowHandle, const Htuple Row, const Htuple Column, const Htuple Button, Htuple *Processed);
LIntExport Herror send_mouse_drag_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, char *Processed);
LIntExport Herror T_send_mouse_up_event(const Htuple WindowHandle, const Htuple Row, const Htuple Column, const Htuple Button, Htuple *Processed);
LIntExport Herror send_mouse_up_event(Hlong WindowHandle, Hlong Row, Hlong Column, Hlong Button, char *Processed);
LIntExport Herror T_serialize_dual_quat(const Htuple DualQuaternion, Htuple *SerializedItemHandle);
LIntExport Herror T_serialize_ocr_class_cnn(const Htuple OCRHandle, Htuple *SerializedItemHandle);
LIntExport Herror serialize_ocr_class_cnn(Hlong OCRHandle, Hlong *SerializedItemHandle);
LIntExport Herror T_serialize_texture_inspection_model(const Htuple TextureInspectionModel, Htuple *SerializedItemHandle);
LIntExport Herror serialize_texture_inspection_model(Hlong TextureInspectionModel, Hlong *SerializedItemHandle);
LIntExport Herror T_set_content_update_callback(const Htuple WindowHandle, const Htuple CallbackFunction, const Htuple CallbackContext);
LIntExport Herror set_content_update_callback(Hlong WindowHandle, Hlong CallbackFunction, Hlong CallbackContext);
LIntExport Herror T_set_rgba(const Htuple WindowHandle, const Htuple Red, const Htuple Green, const Htuple Blue, const Htuple Alpha);
LIntExport Herror set_rgba(Hlong WindowHandle, Hlong Red, Hlong Green, Hlong Blue, Hlong Alpha);
LIntExport Herror T_set_surface_model_param(const Htuple SurfaceModelID, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_surface_model_param(Hlong SurfaceModelID, const char *GenParamName, double GenParamValue);
LIntExport Herror T_set_texture_inspection_model_param(const Htuple TextureInspectionModel, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_texture_inspection_model_param(Hlong TextureInspectionModel, const char *GenParamName, Hlong GenParamValue);
LIntExport Herror T_train_texture_inspection_model(const Htuple TextureInspectionModel);
LIntExport Herror train_texture_inspection_model(Hlong TextureInspectionModel);
LIntExport Herror T_write_texture_inspection_model(const Htuple TextureInspectionModel, const Htuple FileName);
LIntExport Herror write_texture_inspection_model(Hlong TextureInspectionModel, const char *FileName);
LIntExport Herror T_uncalibrated_photometric_stereo(const Hobject Images, Hobject *NormalField, Hobject *Gradient, Hobject *Albedo, const Htuple ResultType);
LIntExport Herror T_apply_dl_classifier(const Hobject Images, const Htuple DLClassifierHandle, Htuple *DLClassifierResultHandle);
LIntExport Herror apply_dl_classifier(const Hobject Images, Hlong DLClassifierHandle, Hlong *DLClassifierResultHandle);
LIntExport Herror T_clear_dl_classifier(const Htuple DLClassifierHandle);
LIntExport Herror clear_dl_classifier(Hlong DLClassifierHandle);
LIntExport Herror T_clear_dl_classifier_result(const Htuple DLClassifierResultHandle);
LIntExport Herror clear_dl_classifier_result(Hlong DLClassifierResultHandle);
LIntExport Herror T_clear_dl_classifier_train_result(const Htuple DLClassifierTrainResultHandle);
LIntExport Herror clear_dl_classifier_train_result(Hlong DLClassifierTrainResultHandle);
LIntExport Herror T_clear_structured_light_model(const Htuple StructuredLightModel);
LIntExport Herror clear_structured_light_model(Hlong StructuredLightModel);
LIntExport Herror T_create_structured_light_model(const Htuple ModelType, Htuple *StructuredLightModel);
LIntExport Herror create_structured_light_model(const char *ModelType, Hlong *StructuredLightModel);
LIntExport Herror T_decode_structured_light_pattern(const Hobject CameraImages, const Htuple StructuredLightModel);
LIntExport Herror decode_structured_light_pattern(const Hobject CameraImages, Hlong StructuredLightModel);
LIntExport Herror T_deserialize_dl_classifier(const Htuple SerializedItemHandle, Htuple *DLClassifierHandle);
LIntExport Herror deserialize_dl_classifier(Hlong SerializedItemHandle, Hlong *DLClassifierHandle);
LIntExport Herror T_deserialize_structured_light_model(const Htuple SerializedItemHandle, Htuple *StructuredLightModel);
LIntExport Herror deserialize_structured_light_model(Hlong SerializedItemHandle, Hlong *StructuredLightModel);
LIntExport Herror T_distance_cc_min_points(const Hobject Contour1, const Hobject Contour2, const Htuple Mode, Htuple *DistanceMin, Htuple *Row1, Htuple *Column1, Htuple *Row2, Htuple *Column2);
LIntExport Herror distance_cc_min_points(const Hobject Contour1, const Hobject Contour2, const char *Mode, double *DistanceMin, double *Row1, double *Column1, double *Row2, double *Column2);
LIntExport Herror T_fuse_object_model_3d(const Htuple ObjectModel3D, const Htuple BoundingBox, const Htuple Resolution, const Htuple SurfaceTolerance, const Htuple MinThickness, const Htuple Smoothing, const Htuple NormalDirection, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ObjectModel3DFusion);
LIntExport Herror T_gen_structured_light_pattern(Hobject *PatternImages, const Htuple StructuredLightModel);
LIntExport Herror gen_structured_light_pattern(Hobject *PatternImages, Hlong StructuredLightModel);
LIntExport Herror T_get_dl_classifier_param(const Htuple DLClassifierHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_dl_classifier_param(Hlong DLClassifierHandle, const char *GenParamName, Hlong *GenParamValue);
LIntExport Herror T_get_dl_classifier_result(const Htuple DLClassifierResultHandle, const Htuple Index, const Htuple GenResultName, Htuple *GenResultValue);
LIntExport Herror get_dl_classifier_result(Hlong DLClassifierResultHandle, const char *Index, const char *GenResultName, double *GenResultValue);
LIntExport Herror T_get_dl_classifier_train_result(const Htuple DLClassifierTrainResultHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_dl_classifier_train_result(Hlong DLClassifierTrainResultHandle, const char *GenParamName, double *GenParamValue);
LIntExport Herror T_get_structured_light_model_param(const Htuple StructuredLightModel, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror get_structured_light_model_param(Hlong StructuredLightModel, const char *GenParamName, Hlong *GenParamValue);
LIntExport Herror T_get_structured_light_object(Hobject *Object, const Htuple StructuredLightModel, const Htuple ObjectName);
LIntExport Herror get_structured_light_object(Hobject *Object, Hlong StructuredLightModel, const char *ObjectName);
LIntExport Herror T_height_width_ratio(const Hobject Regions, Htuple *Height, Htuple *Width, Htuple *Ratio);
LIntExport Herror height_width_ratio(const Hobject Regions, Hlong *Height, Hlong *Width, double *Ratio);
LIntExport Herror T_height_width_ratio_xld(const Hobject XLD, Htuple *Height, Htuple *Width, Htuple *Ratio);
LIntExport Herror height_width_ratio_xld(const Hobject XLD, double *Height, double *Width, double *Ratio);
LIntExport Herror T_insert_obj(const Hobject Objects, const Hobject ObjectsInsert, Hobject *ObjectsExtended, const Htuple Index);
LIntExport Herror insert_obj(const Hobject Objects, const Hobject ObjectsInsert, Hobject *ObjectsExtended, Hlong Index);
LIntExport Herror T_read_dl_classifier(const Htuple FileName, Htuple *DLClassifierHandle);
LIntExport Herror read_dl_classifier(const char *FileName, Hlong *DLClassifierHandle);
LIntExport Herror T_read_structured_light_model(const Htuple FileName, Htuple *StructuredLightModel);
LIntExport Herror read_structured_light_model(const char *FileName, Hlong *StructuredLightModel);
LIntExport Herror T_remove_obj(const Hobject Objects, Hobject *ObjectsReduced, const Htuple Index);
LIntExport Herror remove_obj(const Hobject Objects, Hobject *ObjectsReduced, Hlong Index);
LIntExport Herror T_replace_obj(const Hobject Objects, const Hobject ObjectsReplace, Hobject *Replaced, const Htuple Index);
LIntExport Herror replace_obj(const Hobject Objects, const Hobject ObjectsReplace, Hobject *Replaced, Hlong Index);
LIntExport Herror T_serialize_dl_classifier(const Htuple DLClassifierHandle, Htuple *SerializedItemHandle);
LIntExport Herror serialize_dl_classifier(Hlong DLClassifierHandle, Hlong *SerializedItemHandle);
LIntExport Herror T_serialize_structured_light_model(const Htuple StructuredLightModel, Htuple *SerializedItemHandle);
LIntExport Herror serialize_structured_light_model(Hlong StructuredLightModel, Hlong *SerializedItemHandle);
LIntExport Herror T_set_dl_classifier_param(const Htuple DLClassifierHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_dl_classifier_param(Hlong DLClassifierHandle, const char *GenParamName, const char *GenParamValue);
LIntExport Herror T_set_operator_timeout(const Htuple OperatorName, const Htuple Timeout, const Htuple Mode);
LIntExport Herror set_operator_timeout(const char *OperatorName, double Timeout, const char *Mode);
LIntExport Herror T_set_structured_light_model_param(const Htuple StructuredLightModel, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror set_structured_light_model_param(Hlong StructuredLightModel, const char *GenParamName, Hlong GenParamValue);
LIntExport Herror T_train_dl_classifier_batch(const Hobject BatchImages, const Htuple DLClassifierHandle, const Htuple BatchLabels, Htuple *DLClassifierTrainResultHandle);
LIntExport Herror T_write_dl_classifier(const Htuple DLClassifierHandle, const Htuple FileName);
LIntExport Herror write_dl_classifier(Hlong DLClassifierHandle, const char *FileName);
LIntExport Herror T_write_structured_light_model(const Htuple StructuredLightModel, const Htuple FileName);
LIntExport Herror write_structured_light_model(Hlong StructuredLightModel, const char *FileName);
LIntExport Herror T_clear_handle(const Htuple Handle);
LIntExport Herror clear_handle(Hlong Handle);
LIntExport Herror T_deserialize_handle(const Htuple SerializedItem, Htuple *Handle);
LIntExport Herror deserialize_handle(Hlong SerializedItem, Hlong *Handle);
LIntExport Herror T_handle_to_integer(const Htuple Handle, Htuple *CastedHandle);
LIntExport Herror handle_to_integer(Hlong Handle, Hlong *CastedHandle);
LIntExport Herror T_integer_to_handle(const Htuple IntegerHandle, Htuple *Handle);
LIntExport Herror integer_to_handle(Hlong IntegerHandle, Hlong *Handle);
LIntExport Herror T_serialize_handle(const Htuple Handle, Htuple *SerializedItem);
LIntExport Herror serialize_handle(Hlong Handle, Hlong *SerializedItem);
LIntExport Herror T_tuple_is_handle(const Htuple T, Htuple *IsHandle);
LIntExport Herror tuple_is_handle(Hlong T, Hlong *IsHandle);
LIntExport Herror T_tuple_is_handle_elem(const Htuple T, Htuple *IsHandle);
LIntExport Herror tuple_is_handle_elem(Hlong T, Hlong *IsHandle);
LIntExport Herror T_tuple_is_serializable(const Htuple Tuple, Htuple *IsSerializable);
LIntExport Herror tuple_is_serializable(Hlong Tuple, Hlong *IsSerializable);
LIntExport Herror T_tuple_is_serializable_elem(const Htuple Tuple, Htuple *IsSerializableElem);
LIntExport Herror tuple_is_serializable_elem(Hlong Tuple, Hlong *IsSerializableElem);
LIntExport Herror T_tuple_is_valid_handle(const Htuple Handle, Htuple *IsValid);
LIntExport Herror tuple_is_valid_handle(Hlong Handle, Hlong *IsValid);
LIntExport Herror T_tuple_sem_type(const Htuple T, Htuple *SemType);
LIntExport Herror tuple_sem_type(Hlong T, char *SemType);
LIntExport Herror T_tuple_sem_type_elem(const Htuple T, Htuple *SemTypes);
LIntExport Herror tuple_sem_type_elem(Hlong T, char *SemTypes);
LIntExport Herror T_apply_dl_model(const Htuple DLModelHandle, const Htuple DLSampleBatch, const Htuple Outputs, Htuple *DLResultBatch);
LIntExport Herror T_clear_dl_model(const Htuple DLModelHandle);
LIntExport Herror T_copy_dict(const Htuple DictHandle, const Htuple GenParamName, const Htuple GenParamValue, Htuple *CopiedDictHandle);
LIntExport Herror T_create_dict(Htuple *DictHandle);
LIntExport Herror T_create_dl_model_detection(const Htuple Backbone, const Htuple NumClasses, const Htuple DLModelDetectionParam, Htuple *DLModelHandle);
LIntExport Herror T_deserialize_dl_model(const Htuple SerializedItemHandle, Htuple *DLModelHandle);
LIntExport Herror T_get_current_hthread_id(Htuple *HThreadID);
LIntExport Herror get_current_hthread_id(Hlong *HThreadID);
LIntExport Herror T_get_dict_object(Hobject *Object, const Htuple DictHandle, const Htuple Key);
LIntExport Herror T_get_dict_param(const Htuple DictHandle, const Htuple GenParamName, const Htuple Key, Htuple *GenParamValue);
LIntExport Herror T_get_dict_tuple(const Htuple DictHandle, const Htuple Key, Htuple *Tuple);
LIntExport Herror T_get_dl_model_param(const Htuple DLModelHandle, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_get_handle_object(Hobject *Object, const Htuple Handle, const Htuple Key);
LIntExport Herror T_get_handle_param(const Htuple Handle, const Htuple GenParamName, const Htuple Key, Htuple *GenParamValue);
LIntExport Herror T_get_handle_tuple(const Htuple Handle, const Htuple Key, Htuple *Tuple);
LIntExport Herror T_get_system_info(const Htuple Query, Htuple *Information);
LIntExport Herror get_system_info(const char *Query, Hlong *Information);
LIntExport Herror T_interrupt_operator(const Htuple HThreadID, const Htuple Mode);
LIntExport Herror interrupt_operator(Hlong HThreadID, const char *Mode);
LIntExport Herror T_read_dict(const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DictHandle);
LIntExport Herror T_read_dl_model(const Htuple FileName, Htuple *DLModelHandle);
LIntExport Herror T_read_message(const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *MessageHandle);
LIntExport Herror T_remove_dict_key(const Htuple DictHandle, const Htuple Key);
LIntExport Herror T_send_key_press_event(const Htuple WindowHandle, const Htuple Char, const Htuple Code);
LIntExport Herror send_key_press_event(Hlong WindowHandle, const char *Char, Hlong Code);
LIntExport Herror T_send_key_release_event(const Htuple WindowHandle, const Htuple Char, const Htuple Code);
LIntExport Herror send_key_release_event(Hlong WindowHandle, const char *Char, Hlong Code);
LIntExport Herror T_serialize_dl_model(const Htuple DLModelHandle, Htuple *SerializedItemHandle);
LIntExport Herror T_set_dict_object(const Hobject Object, const Htuple DictHandle, const Htuple Key);
LIntExport Herror T_set_dict_tuple(const Htuple DictHandle, const Htuple Key, const Htuple Tuple);
LIntExport Herror T_set_dl_model_param(const Htuple DLModelHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_train_dl_model_batch(const Htuple DLModelHandle, const Htuple DLSampleBatch, Htuple *DLTrainResult);
LIntExport Herror T_write_dict(const Htuple DictHandle, const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_write_dl_model(const Htuple DLModelHandle, const Htuple FileName);
LIntExport Herror T_write_message(const Htuple MessageHandle, const Htuple FileName, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_area_intersection_rectangle2(const Htuple Rect1Row, const Htuple Rect1Column, const Htuple Rect1Phi, const Htuple Rect1Length1, const Htuple Rect1Length2, const Htuple Rect2Row, const Htuple Rect2Column, const Htuple Rect2Phi, const Htuple Rect2Length1, const Htuple Rect2Length2, Htuple *AreaIntersection);
LIntExport Herror area_intersection_rectangle2(double Rect1Row, double Rect1Column, double Rect1Phi, double Rect1Length1, double Rect1Length2, double Rect2Row, double Rect2Column, double Rect2Phi, double Rect2Length1, double Rect2Length2, double *AreaIntersection);
LIntExport Herror T_get_contour_style(const Htuple WindowHandle, Htuple *Style);
LIntExport Herror T_get_shape_model_clutter(Hobject *ClutterRegion, const Htuple ModelID, const Htuple GenParamName, Htuple *GenParamValue, Htuple *HomMat2D, Htuple *ClutterContrast);
LIntExport Herror T_set_contour_style(const Htuple WindowHandle, const Htuple Style);
LIntExport Herror T_set_shape_model_clutter(const Hobject ClutterRegion, const Htuple ModelID, const Htuple HomMat2D, const Htuple ClutterContrast, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_find_box_3d(const Htuple ObjectModel3DScene, const Htuple SideLen1, const Htuple SideLen2, const Htuple SideLen3, const Htuple MinScore, const Htuple GenParam, Htuple *GrippingPose, Htuple *Score, Htuple *ObjectModel3DBox, Htuple *BoxInformation);
LIntExport Herror T_fread_bytes(const Htuple FileHandle, const Htuple NumberOfBytes, Htuple *ReadData, Htuple *IsEOF);
LIntExport Herror T_fwrite_bytes(const Htuple FileHandle, const Htuple DataToWrite, Htuple *NumberOfBytesWritten);
LIntExport Herror T_gen_dl_model_heatmap(const Htuple DLModelHandle, const Htuple DLSample, const Htuple HeatmapMethod, const Htuple TargetClasses, const Htuple GenParam, Htuple *DLResult);
LIntExport Herror T_read_image_metadata(const Htuple Format, const Htuple TagName, const Htuple FileName, Htuple *TagValue);
LIntExport Herror read_image_metadata(const char *Format, const char *TagName, const char *FileName, char *TagValue);
LIntExport Herror T_rectangularity_xld(const Hobject XLD, Htuple *Rectangularity);
LIntExport Herror rectangularity_xld(const Hobject XLD, double *Rectangularity);
LIntExport Herror T_remove_object_model_3d_attrib(const Htuple ObjectModel3D, const Htuple Attributes, Htuple *ObjectModel3DOut);
LIntExport Herror T_remove_object_model_3d_attrib_mod(const Htuple ObjectModel3D, const Htuple Attributes);
LIntExport Herror T_train_dl_model_anomaly_dataset(const Htuple DLModelHandle, const Htuple DLSamples, const Htuple DLTrainParam, Htuple *DLTrainResult);
LIntExport Herror T_watersheds_marker(const Hobject Image, const Hobject Markers, Hobject *Basins);
LIntExport Herror watersheds_marker(const Hobject Image, const Hobject Markers, Hobject *Basins);
LIntExport Herror T_write_image_metadata(const Htuple Format, const Htuple TagName, const Htuple TagValue, const Htuple FileName);
LIntExport Herror write_image_metadata(const char *Format, const char *TagName, const char *TagValue, const char *FileName);
